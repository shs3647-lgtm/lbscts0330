...
const SECRET_KEY = process.env.APPROVAL_SECRET_KEY || (() => {
  console.error('[approvalToken] APPROVAL_SECRET_KEY 환경변수가 설정되지 않았습니다. 기본값을 사용합니다.');
  return 'fmea-default-secret-change-in-production';
})();
