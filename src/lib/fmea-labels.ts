...
const DFMEA_LABELS: FmeaLabels = {
  ...
  l1FuncGroup: '시스템 기능/요구사항',
  l1FuncGroupEn: 'System Function/Requirements',
  l2FuncGroup: '초점요소 기능 및 제품특성',
  l2FuncGroupEn: 'Focus Element Function & Char.',
  l3FuncGroup: '부품 기능 및 설계특성',
  l3FuncGroupEn: 'Component Function & Design Char.',
  l1Func: '시스템기능',
  l1FuncEn: 'System Function',
  l2Func: '초점요소기능',
  l2FuncEn: 'Focus Element Function',
  l3Func: '부품기능',
  l3FuncEn: 'Component Function',
  l3Char: '설계특성',
  l3CharEn: 'Design Char.',

  l2Failure: '초점요소 고장형태(FM)',
  l3Failure: '부품 고장원인(FC)',
  ...
  l2CellBr: 'NO+<br />초점요소',
  l3CellBr: '부품',
  l1FuncBr: '1.시스템기능<br />/요구사항',
  l2FuncBr: '2.초점요소기능<br />및 제품특성',
  l3FuncBr: '3.부품기능<br />및 설계특성',
  l1FuncCellBr: '시스템<br />기능',
  l2FuncCellBr: '초점요소<br />기능',
  l3FuncCellBr: '부품<br />기능',
  l3CharCellBr: '설계<br />특성',
  l2FailureBr: '2.초점요소<br />고장형태(FM)',
  l3FailureBr: '3.부품<br />고장원인(FC)',
};
