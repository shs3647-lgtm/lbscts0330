...
export function SyncConflictModal({
  ...
  const { pos, size, onDragStart, onResizeStart } = useFloatingWindow({
    isOpen, width: 672, height: 600, minWidth: 500, minHeight: 400
  });
  ...
  return createPortal(
    ...
    >
        {/* 헤더 */}
        <div className="px-6 py-4 border-b bg-yellow-50 cursor-move shrink-0 rounded-t-lg" onMouseDown={onDragStart}>
          <div className="flex items-center gap-2">
            <span className="text-2xl">⚠️</span>
            <h2 className="text-lg font-semibold text-gray-900">
              데이터 충돌 감지
            </h2>
            <span className="ml-auto text-sm text-gray-600" onMouseDown={e => e.stopPropagation()}>
        ...
        {/* 일괄 적용 버튼 */}
        <div className="px-6 py-3 bg-gray-50 border-b flex items-center gap-2 flex-wrap shrink-0">
        ...
        {/* 푸터 */}
        <div className="px-6 py-4 border-t bg-gray-50 flex items-center justify-end gap-3 shrink-0 rounded-b-lg">
