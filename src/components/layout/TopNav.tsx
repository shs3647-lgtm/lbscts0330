      ...
      <div className="flex h-full items-center justify-between px-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent>
              <DropdownMenuItem>{t('PFMEA 임포트')}</DropdownMenuItem>
              <DropdownMenuItem>{t('DFMEA 임포트')}</DropdownMenuItem>
              <DropdownMenuItem>CP Import</DropdownMenuItem>
              <DropdownMenuItem>BOM Import</DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent>
              <DropdownMenuItem>{t('내 정보')}</DropdownMenuItem>
              <DropdownMenuItem>{t('설정')}</DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
        </div>
      </div>
