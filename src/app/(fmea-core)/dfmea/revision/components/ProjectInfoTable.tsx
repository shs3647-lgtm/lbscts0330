            ...
            <table className="w-full border-collapse text-xs">
                <thead>
                    <tr className="bg-[#00587a] text-white">
                        <th className="border border-white px-2 py-2 text-center w-[16%]">FMEA ID</th>
                        <th className="border border-white px-2 py-2 text-center w-[16%]" title="FMEA Name">FMEA명(Name)</th>
                        <th className="border border-white px-2 py-2 text-center w-[16%]" title="Plant">공장(Plant)</th>
                        <th className="border border-white px-2 py-2 text-center w-[16%]" title="FMEA Responsible Person">FMEA담당자(Owner)</th>
                        <th className="border border-white px-2 py-2 text-center w-[16%]" title="Customer">고객(Customer)</th>
                    ...
                    <tr className="bg-white h-10">
                        ...
                        <td className="border border-gray-400 px-1 py-1 bg-gray-50">
                            <span
                                ...
                                title="클릭하여 DFMEA 리스트로 이동(Click to go to DFMEA List)"
                                onClick={() => selectedInfo.fmeaId && router.push('/dfmea/list')}
                            >
                                {selectedInfo.fmeaId || '-'}
                            </span>
                        </td>
                        ...
                        <td className="border border-gray-400 px-1 py-1 bg-gray-50">
                            <span
                                ...
                                title="클릭하여 DFMEA 워크시트로 이동(Click to go to DFMEA Worksheet)"
                                onClick={() => selectedInfo.fmeaId && router.push(`/dfmea/worksheet?id=${selectedInfo.fmeaId}`)}
                            >
