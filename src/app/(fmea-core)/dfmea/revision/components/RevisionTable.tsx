...
export function RevisionTable({
    ...
    // ★ 상태 변경 핸들러 (개정이력에는 사용자 입력 사유만 기록, 결재 로그 미기록)
                    ...
                    <thead className="sticky top-0 z-10 bg-[#00587a]">
                        <tr className="bg-[#00587a] text-white h-[28px] text-[9px]">
                            ...
                            {(handleBackup || handleRestore || handleApprovalRequest) && (
                                <th className="border border-white px-1 py-1 text-center align-middle w-14 bg-[#00587a]" title="Management">관리<br /><span className="text-[7px] font-normal opacity-70">Mgmt</span></th>
                            )}
                        </tr>
                    </thead>
                    <tbody>
