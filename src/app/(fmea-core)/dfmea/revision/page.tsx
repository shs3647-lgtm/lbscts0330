...
function RevisionManagementPageInner() {
    ...
    const handleGoToRegister = () => {
        ...
        window.location.href = `/dfmea/register?id=${selectedProjectId}&rev=Rev.${String(newRevNo).padStart(2, '0')}`;
    };
        ...
        >
            <div className="h-full overflow-y-auto px-[10px] py-[10px] font-[Malgun_Gothic]">
                <div className="flex items-center gap-2 mb-4">
                    ...
                    <h1 className="text-base font-bold text-gray-800">D-FMEA 개정관리 현황(Revision Management)</h1>
                    {isNewRevMode && (
