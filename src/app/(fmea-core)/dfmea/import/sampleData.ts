/**
 * @file sampleData.ts
 * @description DFMEA Import 페이지용 샘플 데이터 및 드롭다운 옵션
 */
/**
 * ██████████████████████████████████████████████████████████████
...
// 샘플 데이터 (DFMEA기초정보입력.xlsx 기반) — v3.0: A6/B5 제거
...
export const PREVIEW_OPTIONS = [
  ...
  { value: 'B3', label: 'L3-3(B3) 공정특성', sheetName: 'L3-3(B3) 공정특성', colIndex: 2 },
  { value: 'B4', label: 'L3-4(B4) 고장원인', sheetName: 'L3-4(B4) 고장원인', colIndex: 2 },
