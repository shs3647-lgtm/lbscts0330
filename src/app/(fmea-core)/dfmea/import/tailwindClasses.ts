 ...
 * @description DFMEA Import 페이지용 Tailwind CSS 클래스 정의
 */
...
export const tw = {
  ...
  // 헤더 셀
  headerCell: 'bg-[#00587a] text-white border border-gray-400 px-1 py-0.5 font-bold text-center whitespace-nowrap h-6 text-[9px]',
  headerCellSm: 'bg-[#00587a] text-white border border-gray-400 px-1 py-0.5 font-bold text-center whitespace-nowrap h-6 text-[9px]',
  // 행 헤더
  rowHeader: 'bg-[#00587a] text-white border border-gray-400 px-1 py-0.5 font-bold text-center whitespace-nowrap h-6 text-[9px]',
  rowHeaderSm: 'bg-[#00587a] text-white border border-gray-400 px-1 py-0.5 font-bold text-center whitespace-nowrap h-6 text-[9px]',
  // 일반 셀
  cell: 'bg-white border border-gray-400 px-1 py-0.5 whitespace-nowrap h-6 text-[9px]',
  cellCenter: 'bg-white border border-gray-400 px-1 py-0.5 whitespace-nowrap h-6 text-[9px] text-center',
  cellPad: 'bg-white border border-gray-400 p-0.5 whitespace-nowrap h-6 text-[9px] text-center',
  cellBlue: 'bg-[#e0f2fb] border border-gray-400 px-1 py-0.5 whitespace-nowrap h-6 text-[9px]',
  // 버튼
  btnPrimary: 'px-2 py-0.5 bg-[#00587a] text-white border-none rounded cursor-pointer whitespace-nowrap text-[10px]',
  btnSuccess: 'w-full px-4 py-1.5 bg-green-500 text-white border-none rounded cursor-pointer text-[11px] font-bold',
  btnSuccessDisabled: 'w-full px-4 py-1.5 bg-gray-300 text-white border-none rounded cursor-not-allowed text-[11px] font-bold',
  ...
  // 입력
  select: 'p-0.5 border border-gray-300 rounded w-full text-[9px]',
  selectBold: 'flex-1 px-2 py-1 border border-gray-400 rounded bg-white font-bold text-[10px]',
  selectTab: 'flex-1 px-2 py-1.5 border-none font-bold bg-[#e0f2fb] text-[#00587a] text-[10px]',
  input: 'w-full border border-gray-200 rounded-sm px-0.5 py-0 bg-[#fffef0] text-[9px]',
  inputCenter: 'w-full border border-gray-200 rounded-sm px-0.5 py-0 bg-[#fffef0] text-[9px] text-center',
  // 레이아웃
