 ...
 * @description DFMEA Import 입력 섹션 (기초정보 + 분석데이터)
 * @author AI Assistant
 * @created 2026-01-21
 */
                  ...
                  <td className={tw.cell}>
                    <div className="flex items-center gap-2">
                      <select
                        ...
                        onChange={e => setTemplateMode?.(e.target.value as 'manual' | 'auto')}
                        className="px-2 py-1 border border-gray-400 rounded text-[11px] bg-[#e0f2fb] font-bold"
                      >
                        <option value="manual">② 수동 템플릿</option>
                        <option value="auto">③ 자동 템플릿</option>
                      </select>
                      <span className="text-[10px] text-gray-500">
                        {templateMode === 'auto' ? '작업요소 입력 → B1 완성' : '공정수/4M 설정 → 빈 구조'}
                      </span>
                    </div>
                  </td>
                  <td className={tw.cellCenter}>
