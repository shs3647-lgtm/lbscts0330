 ...
 * @description Import 모드 고정 메뉴바 — 수동 / 자동 / 기존데이터
 * @created 2026-02-26
 */
...
const MODES = [
  { key: 'preprocess', label: '전처리(Preprocess)', path: '/dfmea/import/preprocess' },
  { key: 'manual', label: '수동(Manual)', path: '/dfmea/import/manual' },
  { key: 'auto', label: '자동(Auto)', path: '/dfmea/import/auto' },
  { key: 'legacy', label: '기존데이터(Legacy)', path: '/dfmea/import/legacy' },
] as const;
