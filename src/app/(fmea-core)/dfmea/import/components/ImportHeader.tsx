 ...
 * @description DFMEA Import 페이지 헤더 컴포넌트 (BD 연동 테이블 + 기초정보 데이터 현황)
 * @author AI Assistant
 * @created 2026-01-21
      ...
      <div className="flex items-center gap-2 mb-3">
        ...
        <HelpIcon title="FMEA Basic Data 도움말" popoverWidth={440}>
          <div style={{ lineHeight: 1.9 }}>
            <p style={{ fontWeight: 700, marginBottom: 6, color: '#0c4a6e' }}>DFMEA Basic Data란?</p>
            <p>DFMEA 구조분석 워크시트에 사용되는 기초정보(공정명, 기능, 고장모드 등)를 엑셀로 관리하는 기능입니다.</p>
