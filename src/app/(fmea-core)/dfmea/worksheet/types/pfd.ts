...
export const PFD_COLUMNS = [
  { key: 'seqNo', label: '순번', width: 50, dfmeaSync: false },
  { key: 'processNo', label: '공정번호', width: 80, dfmeaSync: true },
  { key: 'processName', label: '공정명', width: 120, dfmeaSync: true },
  { key: 'processDesc', label: '공정설명', width: 200, dfmeaSync: true },
  { key: 'input', label: '입력', width: 120, dfmeaSync: false },
  { key: 'output', label: '출력', width: 120, dfmeaSync: false },
  { key: 'symbol', label: '기호', width: 60, dfmeaSync: false },
  { key: 'fourM', label: '4M', width: 80, dfmeaSync: true },
  { key: 'specialChar', label: '특별특성', width: 70, dfmeaSync: true },
  { key: 'processType', label: '공정유형', width: 80, dfmeaSync: false },
  { key: 'remarks', label: '비고', width: 150, dfmeaSync: false },
];
