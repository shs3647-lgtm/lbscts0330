...
export interface CPRow {
  ...
  // ===== 연동 메타데이터 =====
  dfmeaProcessId?: string;  // 연결된 PFMEA 공정 ID
  dfmeaWorkElemId?: string; // 연결된 PFMEA 작업요소 ID
...
export const CP_COLUMNS = [
  // 공정현황 (5열)
  { key: 'processNo', label: '공정번호', width: 60, group: '공정현황', dfmeaSync: true },
  { key: 'processName', label: '공정명', width: 80, group: '공정현황', dfmeaSync: true },
  { key: 'processType', label: '형태', width: 50, group: '공정현황' },
  { key: 'processDesc', label: '공정설명', width: 200, group: '공정현황', dfmeaSync: true },
  { key: 'workElement', label: '작업요소', width: 100, group: '공정현황', dfmeaSync: true },
  
  // 관리항목 (7열)
  { key: 'ep', label: 'EP', width: 50, group: '관리항목' },
  { key: 'autoInspect', label: '자동검사', width: 70, group: '관리항목' },
  { key: 'itemNo', label: 'NO', width: 40, group: '관리항목' },
  { key: 'productChar', label: '제품특성', width: 100, group: '관리항목', dfmeaSync: true },
  { key: 'processChar', label: '공정특성', width: 50, group: '관리항목', dfmeaSync: true },
  { key: 'specialChar', label: '특별특성', width: 50, group: '관리항목', dfmeaSync: true },
  ...
  { key: 'controlMethod', label: '관리방법', width: 80, group: '관리기준', dfmeaSync: true },
