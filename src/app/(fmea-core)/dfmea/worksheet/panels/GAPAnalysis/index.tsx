...
export default function GAPAnalysis({ state }: GAPAnalysisProps) {
  ...
  const gapData = useMemo(() => {
    ...
    items.push({
      category: '구조분석(Structure)',
      label: 'L1 완제품 공정명(Product Line)',
      current: hasL1 ? 1 : 0,
      target: 1,
    ...
    items.push({
      category: '기능분석(Function)',
      label: 'L1 기능(Function)',
      current: l1FuncCount,
      target: 3,
