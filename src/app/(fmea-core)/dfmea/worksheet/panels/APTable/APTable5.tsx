          ...
          <div className="p-3 overflow-y-auto text-xs">
            ...
            {(direction === 'O_ONLY' || direction === 'BOTH') && (
              <>
                ...
                <label className="text-[10px] font-semibold text-green-700 mb-0.5 block">🛡️ {t('설계검증 예방 개선안')}</label>
            ...
            {(direction === 'D_ONLY' || direction === 'BOTH') && (
              <>
                ...
                <label className="text-[10px] font-semibold text-blue-700 mb-0.5 block">🔍 {t('설계검증 검출 개선안')}</label>
                <textarea
