...
const TREE_STRUCTURE_HELP: HelpSection = {
  label: '트리뷰 읽는 법',
  items: [
    { title: '헤더 숫자', desc: '완제품(1), 메인공정(7), 작업요소(40) 등 — 괄호 안 숫자는 해당 항목의 총 개수입니다.' },
...
export const TREE_HELP: Record<string, TabHelp> = {
  structure: {
    title: '2단계(Step) 구조분석',
    summary: '완제품 → 메인공정 → 작업요소의 3계층 트리 구조를 보여줍니다.',
    sections: [
      {
        label: '트리 구조 (3계층)',
        items: [
          { title: '1L 완제품 공정명', desc: '최상위 노드. 품명 + "생산공정" 형식입니다. (예: Motor Controller IC 생산공정)' },
          { title: '2L 메인공정', desc: '공정번호-공정명 형태로 표시됩니다. (예: 10-SMT, 20-수삽)' },
          { title: '3L 작업요소', desc: '4M(사람/설비/부자재/환경)별 색상 배지와 함께 표시됩니다.' },
      ...
      },
      {
        label: '트리뷰 배지 의미',
        items: [
          { title: '연결됨 N개', desc: '해당 공정에 연결된 작업요소 개수입니다.' },
          { title: '누락 N개 (빨간색)', desc: '기초정보에는 있지만 아직 연결하지 않은 작업요소 개수입니다.' },
        ],
      },
  ...
  'function-l2': {
    title: '2L 기능분석',
    summary: '메인공정별 공정기능과 제품특성 트리를 보여줍니다.',
    sections: [
      TREE_STRUCTURE_HELP,
      {
        label: '트리 구조',
        items: [
          { title: '메인공정 노드', desc: '공정번호-공정명으로 표시됩니다.' },
          { title: '공정기능', desc: '각 공정이 수행하는 기능입니다.' },
          { title: '제품특성', desc: '공정에서 관리해야 할 제품의 특성입니다.' },
        ],
      },
      {
  ...
  'function-l3': {
    title: '3L 기능분석',
    summary: '작업요소별 작업기능과 공정특성 트리를 보여줍니다.',
    sections: [
      TREE_STRUCTURE_HELP,
      {
        label: '트리 구조',
        items: [
          { title: '메인공정 노드', desc: '상위 공정 구분입니다.' },
          { title: '작업요소 노드', desc: '4M 색상 배지와 함께 표시됩니다.' },
          { title: '작업기능', desc: '각 작업요소가 수행하는 기능입니다.' },
          { title: '공정특성', desc: '작업요소에서 관리해야 할 공정의 특성입니다.' },
        ],
      },
      CELL_OPERATION_HELP,
      HEADER_BUTTONS_AUTO_HELP,
  ...
  'failure-l2': {
    ...
    sections: [
      TREE_STRUCTURE_HELP,
      {
        label: '트리 구조',
        items: [
          { title: '메인공정 노드', desc: '공정번호-공정명으로 그룹화됩니다.' },
          { title: '고장형태(FM)', desc: '제품특성이 충족되지 않는 방식(고장 모드)입니다.' },
        ],
      },
      {
        label: '선행 조건',
        items: [
          { title: '2L 기능분석 확정 필수', desc: '공정기능/제품특성을 먼저 확정해야 합니다.' },
        ],
      },
      CELL_OPERATION_HELP,
      HEADER_BUTTONS_AUTO_HELP,
  ...
  'failure-l3': {
    title: '3L 고장분석',
    summary: '작업요소별 고장원인(FC)과 발생도(O) 트리를 보여줍니다.',
    sections: [
      TREE_STRUCTURE_HELP,
      {
        label: '트리 구조',
      ...
      },
      {
        label: '선행 조건',
        items: [
          { title: '3L 기능분석 확정 필수', desc: '작업요소기능/공정특성을 먼저 확정해야 합니다.' },
        ],
      },
      CELL_OPERATION_HELP,
      HEADER_BUTTONS_AUTO_HELP,
    ...
    sections: [
      {
        ...
        items: [
          ...
          { title: 'O (발생도)', desc: '고장원인의 발생 빈도. 예방관리(PC)의 효과에 따라 평가합니다. (1~10)' },
          { title: 'D (검출도)', desc: '현재 검출관리(DC)의 검출 능력. 검출방법 성숙도에 따라 평가합니다. (1~10)' },
      ...
      },
      {
        label: '예방/검출관리',
        items: [
          { title: '예방관리 (PC)', desc: 'B5 항목. Import 기초정보에서 FC↔PC 1:1 매칭으로 자동 추천됩니다.' },
          { title: '검출관리 (DC)', desc: 'A6 항목. Import 기초정보에서 FC↔DC 매칭으로 자동 추천됩니다.' },
          { title: 'O값 자동평가', desc: '예방관리 텍스트를 분석하여 발생도(O)를 자동 산출합니다. (상한 O≤4)' },
          { title: 'D값 자동평가', desc: '검출관리 텍스트를 분석하여 검출도(D)를 자동 산출합니다. (상한 D≤4)' },
        ],
      },
      {
        label: 'RPN 차트',
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { title: 'O/D 자동 재평가', desc: '개선 예방/검출관리 텍스트에서 O/D 값이 자동으로 재산출됩니다.' },
        ],
      },
      {
  ...
  all: {
    ...
    sections: [
      ...
      },
      {
        label: '주요 기능',
        items: [
          { title: '예방관리 자동추천', desc: 'O매칭 버튼 → Import FC↔PC 1:1 매칭으로 예방관리(PC)를 자동 채움합니다.' },
          { title: '검출관리 자동추천', desc: 'Import FC↔DC 매칭으로 검출관리(DC)를 자동 채움합니다.' },
