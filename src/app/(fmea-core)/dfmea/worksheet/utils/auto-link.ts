...
/**
 * 3L 기능분석: 동일한 기능에 연결된 설계파라미터들 찾기
 */
...
/**
 * 고장 3L: 동일한 설계파라미터에 연결된 고장원인들 찾기
 */
