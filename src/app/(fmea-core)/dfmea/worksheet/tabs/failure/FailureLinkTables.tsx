  ...
  return (
    <div className="bg-white flex flex-col min-w-0" style={{ ...flexContainerStyle('1 1 60%', `2px solid #ccc`), minWidth: 0, overflow: 'hidden' }}>
      <div className="flex items-center justify-between py-0.5 px-2" style={headerStyle('#fff3e0', `1px solid #ccc`, 'clamp(10px, 1vw, 12px)')}>
        <span className="font-semibold whitespace-nowrap">고장연결</span>
            ...
            <table className="w-full border-collapse">
              <thead>
                <tr>
                  ...
                  <th style={thStyle('#e3f2fd', '8%')}>구분</th>
                  <th style={thStyle('#e3f2fd')}>고장영향</th>
                  <th style={thStyle('#e3f2fd', '6%')}>S</th>
                </tr>
              </thead>
              <tbody>
                {(() => {
            ...
            <table style={tableFullStyle(FONT_SIZES.cell)}>
              <thead>
                <tr>
                  ...
                  <th style={thStyle('#fff3e0')}>고장형태</th>
                </tr>
              </thead>
              <tbody>
                {fmData.map((fm, idx) => {
            ...
            <table style={tableFullStyle(FONT_SIZES.cell)}>
              <thead>
                <tr>
                  ...
                  <th style={thStyle('#e8f5e9', '15%')}>공정명</th>
                  <th style={thStyle('#e8f5e9', '10%')}>작업요소</th>
                  <th style={thStyle('#e8f5e9')}>고장원인</th>
                </tr>
              </thead>
              <tbody>
                {(() => {
