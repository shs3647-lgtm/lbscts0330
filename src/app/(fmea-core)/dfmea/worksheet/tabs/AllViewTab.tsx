...
export function AllViewHeader() {
  return (
    <>
      ...
      {/* 3행: 컬럼명 */}
      <tr>
        {[{ko:'완제품 공정명',en:'Product'},{ko:'NO+공정명',en:'Process'},{ko:'4M',en:''},{ko:'작업요소',en:'Work Element'}].map(t => <th key={t.ko} style={colH(COLORS.structure.cell)}>{t.en ? <BiHeader ko={t.ko} en={t.en} /> : t.ko}</th>)}
