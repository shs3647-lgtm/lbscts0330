...
export default function EPDevicePopup({
  ...
  const modalContent = (
    <div className="fixed z-[9999] bg-white rounded-xl flex flex-col shadow-2xl select-none border border-gray-300"
      ...
      {/* 헤더 */}
      <div className="text-white py-3 px-5 rounded-t-xl flex justify-between items-center cursor-move" style={headerGradientStyle} onMouseDown={onDragStart}>
        <div>
        ...
        <button onMouseDown={e => e.stopPropagation()} onClick={onClose} style={btnStyle('#ffffff30')} className="hover:bg-white/20">
          ✕
        </button>
      </div>
