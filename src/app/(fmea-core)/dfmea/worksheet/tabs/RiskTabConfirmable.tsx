    ...
    <>
      <thead className={tw.thead}>
        ...
        <tr>
          <th colSpan={8} className={tw.mainHeader}>
            <div className="flex items-center justify-between">
              <span className="flex-1 text-center"><BiHeader ko="D-FMEA 리스크 분석" en="Risk Analysis (5ST)" /></span>
        ...
        <tr>
          ...
          <th colSpan={2} className={`${tw.detectionHeader} ${tw.subHeader}`}><BiHeader ko="현재 검출관리" en="Current Detection" /></th>
          <th colSpan={4} className={`${tw.evaluationHeader} ${tw.subHeader}`}><BiHeader ko="리스크 평가" en="Risk Evaluation" /></th>
        </tr>
