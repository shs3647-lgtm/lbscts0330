 ...
 * - PC: Prevention Control (설계검증 예방)
 * - DC: Detection Control (설계검증 검출)
...
export const STRUCTURE_COLUMNS: ColumnDef[] = [
  ...
  { id: 'l3Name', label: '부품(컴포넌트)', width: '80px', step: 2 },       // L3 Structure
];
...
export const FUNCTION_COLUMNS: ColumnDef[] = [
  ...
  { id: 'l2Function', label: '설계기능', width: '90px', step: 3 },
  { id: 'l2ProductChar', label: '설계특성', width: '70px', step: 3 },
  { id: 'l3Type', label: '부품(컴포넌트)', width: '50px', step: 3, align: 'center' },
  { id: 'l3Function', label: '부품(컴포넌트)기능', width: '90px', step: 3 },
  { id: 'l3ProcessChar', label: '설계파라미터', width: '70px', step: 3 },
];
...
export const FAILURE_COLUMNS: ColumnDef[] = [
  ...
  { id: 'fcType', label: '부품(컴포넌트)', width: '50px', step: 4, align: 'center' },
  { id: 'failureCause', label: '고장원인(FC)', width: '90px', step: 4 },
];

// 리스크분석 5단계 (8열)
export const RISK_COLUMNS: ColumnDef[] = [
  { id: 'prevention', label: '설계검증 예방(PC)', width: '90px', step: 5 },
  { id: 'occurrence', label: '발생도(O)', width: '35px', step: 5, align: 'center' },
  { id: 'detection', label: '설계검증 검출(DC)', width: '90px', step: 5 },
  ...
  { id: 'lessonLearned', label: 'LLD', width: '80px', step: 5 },
];

// 최적화 6단계 (14열)
export const OPT_COLUMNS: ColumnDef[] = [
  { id: 'preventionImprove', label: '설계검증 예방개선', width: '80px', step: 6 },
  { id: 'detectionImprove', label: '설계검증 검출개선', width: '80px', step: 6 },
...
export const STEP_GROUPS: StepGroup[] = [
  { step: 2, name: 'P-FMEA 구조분석(2ST Structure)', count: 4, bg: '#1565c0', headerBg: '#bbdefb', cellBg: '#e3f2fd' },
  { step: 3, name: 'P-FMEA 기능분석(3ST Function)', count: 8, bg: '#1b5e20', headerBg: '#c8e6c9', cellBg: '#e8f5e9' },
  { step: 4, name: 'P-FMEA 고장분석(4ST Failure)', count: 6, bg: '#c62828', headerBg: '#fff9c4', cellBg: '#fffde7' },
  { step: 5, name: 'P-FMEA 리스크분석(5ST Risk)', count: 8, bg: '#6a1b9a', headerBg: '#e1bee7', cellBg: '#f3e5f5' },
  { step: 6, name: 'P-FMEA 최적화(6ST Optimization)', count: 14, bg: '#e65100', headerBg: '#ffe0b2', cellBg: '#fff3e0' },
];
...
export const SUB_GROUPS: SubGroup[] = [
  ...
  // 기능분석 (3개 서브그룹)
  { label: '1. 완제품 설계기능/요구사항', cols: 3, step: 3 },
  { label: '2. 서브시스템기능 및 설계특성', cols: 2, step: 3 },
  { label: '3. 부품(컴포넌트)의 기능 및 설계파라미터', cols: 3, step: 3 },
  // 고장분석 (3개 서브그룹)
  { label: '1. 자사/고객/사용자 고장영향(FE)', cols: 3, step: 4 },
  { label: '2.고장형태', cols: 1, step: 4 },
  { label: '3. 부품(컴포넌트) 고장원인(FC)', cols: 2, step: 4 },
  // 리스크분석 (3개 서브그룹)
  { label: '현재 설계검증 예방', cols: 2, step: 5 },
  { label: '현재 설계검증 검출', cols: 2, step: 5 },
