    ...
    <thead className="sticky top-0 z-20 bg-white border-b-2 border-black">
      ...
      <tr>
        ...
        <th className="bg-[#f57c00] text-white border border-[#ccc] py-1 px-[9px] text-[11px] font-bold">
          <div className="flex items-center justify-between gap-1">
            <span className="font-bold whitespace-nowrap"><BiHeader ko="3L 고장분석" en="Failure Analysis" /></span>
            <div className="flex gap-1 items-center shrink-0">
              {!isUpstreamConfirmed ? (
      ...
      <tr>
        ...
        <th className="bg-orange-500 text-white border border-[#ccc] border-l-0 p-1 text-[10px] font-bold text-center whitespace-nowrap" style={{ boxShadow: 'inset 0 -2px 0 #2196f3' }}>
