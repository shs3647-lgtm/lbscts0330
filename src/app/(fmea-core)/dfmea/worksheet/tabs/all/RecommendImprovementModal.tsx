 ...
 *
 * - 설계검증 예방(PC) / 설계검증 검출(DC) 선택 후 전체적용
...
export interface RecommendCandidate {
  ...
  // 5단계 현재 관리 텍스트
  curPrevText: string;      // 현재 설계검증 예방(PC) 텍스트
  curDetText: string;       // 현재 설계검증 검출(DC) 텍스트
  // 6단계 기존 개선안 텍스트 (이미 입력된 값)
  curPrevOpt: string;       // 기존 설계검증 예방 개선안
  curDetOpt: string;        // 기존 설계검증 검출 개선안
  // 개선 목표값
              ...
              <div style={{ lineHeight: 1.8 }}>
                ...
                <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 11, marginTop: 4 }}>
                  <tbody>
                    ...
                    <tr><td style={{ padding: '2px 6px', borderBottom: '1px solid #e5e7eb', fontWeight: 600, color: '#2e7d32' }}>설계검증 예방 현재</td><td style={{ padding: '2px 6px', borderBottom: '1px solid #e5e7eb' }}>5단계에서 기입한 현재 설계검증 예방(PC) 방법</td></tr>
                    <tr><td style={{ padding: '2px 6px', borderBottom: '1px solid #e5e7eb', fontWeight: 600, color: '#2e7d32' }}>설계검증 예방 개선</td><td style={{ padding: '2px 6px', borderBottom: '1px solid #e5e7eb' }}>6단계 예방 개선안 — <span style={{ color: '#2e7d32' }}>초록셀</span> 클릭 시 산업DB에서 직접 선택</td></tr>
                    <tr><td style={{ padding: '2px 6px', borderBottom: '1px solid #e5e7eb', fontWeight: 600, color: '#1565c0' }}>설계검증 검출 현재</td><td style={{ padding: '2px 6px', borderBottom: '1px solid #e5e7eb' }}>5단계에서 기입한 현재 설계검증 검출(DC) 방법</td></tr>
                    <tr><td style={{ padding: '2px 6px', borderBottom: '1px solid #e5e7eb', fontWeight: 600, color: '#1565c0' }}>설계검증 검출 개선</td><td style={{ padding: '2px 6px', borderBottom: '1px solid #e5e7eb' }}>6단계 검출 개선안 — <span style={{ color: '#1565c0' }}>파란셀</span> 클릭 시 산업DB에서 직접 선택</td></tr>
                  </tbody>
                </table>
                <hr style={{ margin: '6px 0', borderColor: '#e5e7eb' }} />
                <b>사용 방법</b>
            ...
            <thead className="sticky top-0 z-[1]">
              <tr className="bg-gray-100 text-center text-[9px]">
                ...
                <th className="border border-gray-300 px-0.5 py-0.5" style={{ width: '18%' }}>
                  <div className="text-green-700">설계검증 예방 현재</div><div className="text-[7px] text-gray-400">(PC, O)</div>
                </th>
                <th className="border border-gray-300 px-0.5 py-0.5" style={{ width: '18%' }}>
                  <div className="text-green-700">설계검증 예방 개선</div><div className="text-[7px] text-gray-400">(PC&apos;, O&apos;)</div>
                </th>
                <th className="border border-gray-300 px-0.5 py-0.5" style={{ width: '18%' }}>
                  <div className="text-blue-700">설계검증 검출 현재</div><div className="text-[7px] text-gray-400">(DC, D)</div>
                </th>
                <th className="border border-gray-300 px-0.5 py-0.5" style={{ width: '18%' }}>
                  <div className="text-blue-700">설계검증 검출 개선</div><div className="text-[7px] text-gray-400">(DC&apos;, D&apos;)</div>
                </th>
                <th className="border border-gray-300 px-0.5 py-0.5" style={{ width: '22px' }}>AP&apos;</th>
              </tr>
            </thead>
