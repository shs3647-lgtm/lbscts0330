    ...
    <>
      <thead className="sticky top-0 z-10">
        ...
        <tr>
          ...
          <th style={{ ...HEADER_STYLE(L2.headerLight), width: '25%' }}>설계기능</th>
          <th style={{ ...HEADER_STYLE(L2.headerLight), width: '20%' }}>설계특성</th>
    ...
    <>
      <thead className="sticky top-0 z-10">
        ...
        <tr>
          ...
          <th style={{ ...HEADER_STYLE(L3.headerLight), width: '10%' }}>부품(컴포넌트)</th>
          <th style={{ ...HEADER_STYLE(L3.headerLight), width: '18%' }}>부품(컴포넌트)기능</th>
          <th style={{ ...HEADER_STYLE(L3.headerLight), width: '14%' }}>설계파라미터</th>
