...
export interface AllTabModalsProps {
  // ── DataSelectModal (예방관리/검출관리/특별특성) ──
  ...
  return (
    <>
      ...
      {controlModal.isOpen && state && (() => {
        ...
        // ★ 2026-02-28: 검출관리(A6) → 2섹션 DetectionSectionModal로 라우팅
        ...
        // ★ 2026-02-28: 예방관리(B5) → 2섹션 PreventionSectionModal로 라우팅
      ...
      <DatePickerModal
        ...
        title={dateModal.field === 'targetDate' ? '목표완료일자 선택(Target Date)' : '완료일자 선택(Completion Date)'}
      />
