    ...
    <>
      <table style={evalTableStyle}>
        <thead style={stickyTheadStyle}>
          ...
          <tr>
            ...
            {visibleSteps.includes(5) && <><th colSpan={2} style={subHeaderCellStyle(COLORS.risk.prevention.header)}>현재 설계검증 예방</th><th colSpan={2} style={subHeaderCellStyle(COLORS.risk.detection.header)}>현재 설계검증 검출</th><th colSpan={4} style={subHeaderCellStyle(COLORS.risk.evaluation.header)}>리스크 평가</th></>}
          ...
          <tr>
            ...
            {visibleSteps.includes(3) && <><th style={subHeaderCellStyle(COLORS.function.cell, { boxShadow: 'inset 0 -2px 0 #2196f3' })}>구분</th><th style={subHeaderCellStyle(COLORS.function.cell, { boxShadow: 'inset 0 -2px 0 #2196f3' })}>제품 기능</th><th style={subHeaderCellStyle(COLORS.function.cell, { boxShadow: 'inset 0 -2px 0 #2196f3' })}>요구사항</th><th style={subHeaderCellStyle(COLORS.function.cell, { boxShadow: 'inset 0 -2px 0 #2196f3' })}>초점요소 기능</th><th style={subHeaderCellStyle(COLORS.function.cell, { boxShadow: 'inset 0 -2px 0 #2196f3' })}>설계특성</th><th style={subHeaderCellStyle(COLORS.function.cell, { boxShadow: 'inset 0 -2px 0 #2196f3' })}>부품</th><th style={subHeaderCellStyle(COLORS.function.cell, { boxShadow: 'inset 0 -2px 0 #2196f3' })}>부품 기능</th><th style={subHeaderCellStyle(COLORS.function.cell, { boxShadow: 'inset 0 -2px 0 #2196f3' })}>설계특성</th></>}
            ...
            {visibleSteps.includes(5) && <><th style={subHeaderCellStyle(COLORS.risk.prevention.cell, { boxShadow: 'inset 0 -2px 0 #2196f3' })}>설계검증 예방(PC)</th><th style={subHeaderCellStyle(COLORS.risk.prevention.cell, { boxShadow: 'inset 0 -2px 0 #2196f3' })}>발생도(O)</th><th style={subHeaderCellStyle(COLORS.risk.detection.cell, { boxShadow: 'inset 0 -2px 0 #2196f3' })}>설계검증 검출(DC)</th><th style={subHeaderCellStyle(COLORS.risk.detection.cell, { boxShadow: 'inset 0 -2px 0 #2196f3' })}>검출도(D)</th><th onClick={onAPClick} style={subHeaderCellStyle(COLORS.risk.evaluation.cell, { cursor: 'pointer', boxShadow: 'inset 0 -2px 0 #2196f3' })}>AP 📊</th><th style={subHeaderCellStyle(COLORS.risk.evaluation.cell, { boxShadow: 'inset 0 -2px 0 #2196f3' })}>RPN</th><th style={subHeaderCellStyle(COLORS.risk.evaluation.cell, { boxShadow: 'inset 0 -2px 0 #2196f3' })}>특별특성(SC)</th><th style={subHeaderCellStyle(COLORS.risk.evaluation.cell, { boxShadow: 'inset 0 -2px 0 #2196f3' })}>LLD</th></>}
            {visibleSteps.includes(6) && <><th style={subHeaderCellStyle(COLORS.opt.plan.cell, { boxShadow: 'inset 0 -2px 0 #2196f3' })}>설계검증 예방개선</th><th style={subHeaderCellStyle(COLORS.opt.plan.cell, { boxShadow: 'inset 0 -2px 0 #2196f3' })}>설계검증 검출개선</th><th style={subHeaderCellStyle(COLORS.opt.plan.cell, { boxShadow: 'inset 0 -2px 0 #2196f3' })}>책임자성명</th><th style={subHeaderCellStyle(COLORS.opt.plan.cell, { boxShadow: 'inset 0 -2px 0 #2196f3' })}>목표완료일자</th><th style={subHeaderCellStyle(COLORS.opt.monitor.cell, { boxShadow: 'inset 0 -2px 0 #2196f3' })}>상태</th><th style={subHeaderCellStyle(COLORS.opt.monitor.cell, { boxShadow: 'inset 0 -2px 0 #2196f3' })}>개선결과근거</th><th style={subHeaderCellStyle(COLORS.opt.monitor.cell, { boxShadow: 'inset 0 -2px 0 #2196f3' })}>완료일자</th><th style={subHeaderCellStyle(COLORS.opt.effect.cell, { boxShadow: 'inset 0 -2px 0 #2196f3' })}>심각도(S)</th><th style={subHeaderCellStyle(COLORS.opt.effect.cell, { boxShadow: 'inset 0 -2px 0 #2196f3' })}>발생도(O)</th><th style={subHeaderCellStyle(COLORS.opt.effect.cell, { boxShadow: 'inset 0 -2px 0 #2196f3' })}>검출도(D)</th><th style={subHeaderCellStyle(COLORS.opt.effect.cell, { boxShadow: 'inset 0 -2px 0 #2196f3' })}>특별특성(SC)</th><th style={subHeaderCellStyle(COLORS.opt.effect.cell, { boxShadow: 'inset 0 -2px 0 #2196f3' })}>AP</th><th style={subHeaderCellStyle(COLORS.opt.effect.cell, { boxShadow: 'inset 0 -2px 0 #2196f3' })}>RPN</th><th style={subHeaderCellStyle(COLORS.opt.effect.cell, { boxShadow: 'inset 0 -2px 0 #2196f3' })}>비고</th></>}
          </tr>
        </thead>
        <tbody>
          {rows.length === 0 ? (
      ...
      {controlModal.isOpen && (
        <DataSelectModal
          ...
          title={controlModal.type === 'prevention' ? '설계검증 예방 선택' : controlModal.type === 'detection' ? '설계검증 검출 선택' : '특별특성 선택'}
