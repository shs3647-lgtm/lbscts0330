...
export const COLUMNS_BASE: ColumnDef[] = [
  // ■ 2단계: 구조분석 (4컬럼)
  {
    id: 1, step: '구조분석', group: '1. 완제품 공정명(Product Process)', name: '완제품 공정명', width: 160,
  ...
  {
    id: 2, step: '구조분석', group: '2. 메인 공정명(Main Process)', name: 'NO+공정명', width: 140,
  ...
  {
    id: 3, step: '구조분석', group: '3. 작업 요소명(Work Element)', name: '4M', width: 50,
  ...
  {
    id: 4, step: '구조분석', group: '3. 작업 요소명(Work Element)', name: '작업요소', width: 140,
  ...
  // ■ 3단계: 기능분석 (7컬럼)
  {
    id: 5, step: '기능분석', group: '1. 완제품 공정기능/요구사항(Function/Requirements)', name: '구분', width: 50,
  ...
  {
    id: 6, step: '기능분석', group: '1. 완제품 공정기능/요구사항(Function/Requirements)', name: '완제품기능', width: 170,
  ...
  {
    id: 7, step: '기능분석', group: '1. 완제품 공정기능/요구사항(Function/Requirements)', name: '요구사항', width: 160,
  ...
  {
    id: 8, step: '기능분석', group: '2. 메인공정기능 및 제품특성(Function & Product Char.)', name: '공정 기능', width: 140,
  ...
  {
    id: 9, step: '기능분석', group: '2. 메인공정기능 및 제품특성(Function & Product Char.)', name: '제품특성', width: 110,
  ...
  {
    id: 10, step: '기능분석', group: '3. 작업요소 기능 및 공정특성(WE Func. & Process Char.)', name: '작업요소 기능', width: 140,
  ...
  {
    id: 11, step: '기능분석', group: '3. 작업요소 기능 및 공정특성(WE Func. & Process Char.)', name: '공정특성', width: 110,
  ...
  // ■ 4단계: 고장분석 (4컬럼)
  {
    id: 12, step: '고장분석', group: '1. 고장영향(Failure Effect/FE)', name: '고장영향(FE)', width: 160,
  ...
  {
    id: 13, step: '고장분석', group: '1. 고장영향(Failure Effect/FE)', name: '심각도', width: 50,
    headerColor: '#a5d6a7', cellColor: '#e8f5e9', cellAltColor: '#c8e6c9', align: 'center'
  },
  {
    id: 14, step: '고장분석', group: '2. 고장형태(Failure Mode/FM)', name: '고장형태(FM)', width: 155,
    headerColor: COLORS.failure.fm.headerLight, cellColor: '#c8e6c9', cellAltColor: '#b2dfb4', align: 'left', isDark: true
  },
  {
    id: 15, step: '고장분석', group: '3. 고장원인(Failure Cause/FC)', name: '고장원인(FC)', width: 160,
  ...
  // ■ 5단계: 리스크분석 (7컬럼)
  {
    id: 16, step: '리스크분석', group: '1. 현재 예방관리(Current Prevention)', name: '예방관리(PC)', width: 140,
  ...
  {
    id: 17, step: '리스크분석', group: '1. 현재 예방관리(Current Prevention)', name: '발생도', width: 50,
  ...
  {
    id: 18, step: '리스크분석', group: '2. 현재 검출관리(Current Detection)', name: '검출관리(DC)', width: 140,
  ...
  {
    id: 19, step: '리스크분석', group: '2. 현재 검출관리(Current Detection)', name: '검출도', width: 50,
  ...
  {
    id: 20, step: '리스크분석', group: '3. 리스크 평가(Risk Evaluation)', name: 'AP', width: 30,
  ...
  {
    id: 21, step: '리스크분석', group: '3. 리스크 평가(Risk Evaluation)', name: '특별특성', width: 50,
    headerColor: COLORS.risk.evaluation.headerLight, cellColor: COLORS.risk.evaluation.cell, cellAltColor: COLORS.risk.evaluation.cellAlt, align: 'center'
  },
  {
    id: 22, step: '리스크분석', group: '3. 리스크 평가(Risk Evaluation)', name: 'LLD', width: 65,
  ...
  // ■ 6단계: 최적화 (13컬럼)
  {
    id: 23, step: '최적화', group: '1. 계획(Plan)', name: '예방관리개선', width: 140,
  ...
  {
    id: 24, step: '최적화', group: '1. 계획(Plan)', name: '검출관리개선', width: 140,
  ...
  {
    id: 25, step: '최적화', group: '1. 계획(Plan)', name: '책임자성명', width: 80,
  ...
  {
    id: 26, step: '최적화', group: '1. 계획(Plan)', name: '목표완료일자', width: 70,
  ...
  {
    id: 27, step: '최적화', group: '1. 계획(Plan)', name: '상태', width: 50,
  ...
  {
    id: 28, step: '최적화', group: '2. 모니터링(Monitoring)', name: '개선결과근거', width: 100,
  ...
  {
    id: 29, step: '최적화', group: '2. 모니터링(Monitoring)', name: '완료일자', width: 70,
  ...
  {
    id: 30, step: '최적화', group: '3. 효과 평가(Effect Evaluation)', name: '심각도', width: 50,
  ...
  {
    id: 31, step: '최적화', group: '3. 효과 평가(Effect Evaluation)', name: '발생도', width: 50,
  ...
  {
    id: 32, step: '최적화', group: '3. 효과 평가(Effect Evaluation)', name: '검출도', width: 50,
  ...
  {
    id: 33, step: '최적화', group: '3. 효과 평가(Effect Evaluation)', name: '특별특성', width: 50,
  ...
  {
    id: 34, step: '최적화', group: '3. 효과 평가(Effect Evaluation)', name: 'AP', width: 30,
  ...
  {
    id: 35, step: '최적화', group: '3. 효과 평가(Effect Evaluation)', name: '비고', width: 80,
...
export const STEP_LABELS: Record<string, string> = {
  '구조분석': '2단계 구조분석(Structure)',
  '기능분석': '3단계 기능분석(Function)',
  '고장분석': '4단계 고장분석(Failure)',
  '리스크분석': '5단계 리스크분석(Risk)',
  '최적화': '6단계 최적화(Optimization)',
};
