...
export const LEVEL_COLORS = {
  ...
  // 3L: 주황색 (부품(컴포넌트)/부품(컴포넌트)기능/3L 고장원인)
  L3: {
...
export const COLUMNS_BASE: ColumnDef[] = [
  ...
  {
    id: 4, step: '구조분석', group: '3. 작업 요소명', name: '부품(컴포넌트)', width: 140,
  ...
  // ■ 3단계: 기능분석 (7컬럼)
  {
    id: 5, step: '기능분석', group: '1. 완제품 설계기능/요구사항', name: '구분', width: 50,
  ...
  {
    id: 6, step: '기능분석', group: '1. 완제품 설계기능/요구사항', name: '완제품기능', width: 170,
  ...
  {
    id: 7, step: '기능분석', group: '1. 완제품 설계기능/요구사항', name: '요구사항', width: 160,
  ...
  {
    id: 8, step: '기능분석', group: '2. 서브시스템기능 및 설계특성', name: '공정 기능', width: 140,
  ...
  {
    id: 9, step: '기능분석', group: '2. 서브시스템기능 및 설계특성', name: '설계특성', width: 110,
  ...
  {
    id: 10, step: '기능분석', group: '3. 부품(컴포넌트) 기능 및 설계파라미터', name: '부품(컴포넌트) 기능', width: 140,
  ...
  {
    id: 11, step: '기능분석', group: '3. 부품(컴포넌트) 기능 및 설계파라미터', name: '설계파라미터', width: 110,
  ...
  // ■ 5단계: 리스크분석 (7컬럼)
  {
    id: 16, step: '리스크분석', group: '1. 현재 설계검증 예방', name: '설계검증 예방(PC)', width: 140,
  ...
  {
    id: 17, step: '리스크분석', group: '1. 현재 설계검증 예방', name: '발생도(O)', width: 50,
  ...
  {
    id: 18, step: '리스크분석', group: '2. 현재 설계검증 검출', name: '설계검증 검출(DC)', width: 140,
  ...
  {
    id: 19, step: '리스크분석', group: '2. 현재 설계검증 검출', name: '검출도(D)', width: 50,
  ...
  // ■ 6단계: 최적화 (13컬럼)
  {
    id: 23, step: '최적화', group: '1. 계획', name: '설계검증 예방개선', width: 140,
  ...
  {
    id: 24, step: '최적화', group: '1. 계획', name: '설계검증 검출개선', width: 140,
