        ...
        <div className="p-3 text-xs">
          ...
          {selected && (
            <div className="border-t pt-2">
              ...
              <label className="text-[10px] font-semibold text-green-700 mb-0.5 block">🛡️ 설계검증 예방 개선안</label>
              {needsO ? (
              ...
              <label className="text-[10px] font-semibold text-blue-700 mb-0.5 block">🔍 설계검증 검출 개선안</label>
              {needsD ? (
