 ...
 * @description AIAG-VDA FMEA 1st Edition 기반 설계검증 예방/설계검증 검출 개선 추천 데이터
 *
...
export const PREVENTION_IMPROVEMENT_MAP: Record<string, PreventionImprovement> = {
  'O10': {
    ...
    rationale: '표P2: 설계검증 예방 없음(O=10) → 행동적 관리 도입으로 다소 효과적(O=7) 달성',
  },
  'O9': {
