 ...
 * @description 설계검증 예방(PC) 3단계 매칭 규칙
 *
 * 1차: 4M 카테고리 → 설계검증 예방 기본 추천
 * 2차: FC(고장원인) 키워드 → 설계검증 예방 매칭 (17개 규칙)
 * 3차: FM(고장형태) 키워드 → 설계검증 예방 매칭 (11개 규칙)
 *
...
/**
 * B5 후보에 대한 3단계 설계검증 예방 규칙 매칭 랭킹
 *
