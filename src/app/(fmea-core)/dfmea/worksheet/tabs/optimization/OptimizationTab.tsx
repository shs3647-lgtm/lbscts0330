...
const COLUMNS_BASE: ColumnDef[] = [
  // 1. 계획 (5컬럼)
  { id: 1, group: '1. 계획', name: '설계검증 예방개선', width: 160, headerColor: COLORS.plan.headerLight, cellColor: COLORS.plan.cell, cellAltColor: COLORS.plan.cellAlt, align: 'left' },
  { id: 2, group: '1. 계획', name: '설계검증 검출개선', width: 160, headerColor: COLORS.plan.headerLight, cellColor: COLORS.plan.cell, cellAltColor: COLORS.plan.cellAlt, align: 'left' },
  ...
  { id: 11, group: '3. 효과 평가', name: '특별특성(SC)', width: 70, headerColor: COLORS.evaluation.headerLight, cellColor: COLORS.evaluation.cell, cellAltColor: COLORS.evaluation.cellAlt, align: 'center' },
