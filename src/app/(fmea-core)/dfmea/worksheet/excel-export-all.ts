...
async function createSheet2_FMEAAll(
  ...
  const ALLVIEW_COLUMNS = [
    ...
    { id: 'l2Function', label: '공정기능', width: 18, group: 'function' },
    { id: 'productChar', label: '제품특성', width: 12, group: 'function' },
    { id: 'l3Function', label: '작업요소기능', width: 15, group: 'function' },
    { id: 'processChar', label: '공정특성', width: 12, group: 'function' },
    ...
    { id: 'prevention', label: '예방관리', width: 12, group: 'risk' },
    { id: 'occurrence', label: 'O', width: 4, group: 'risk' },
    { id: 'detection', label: '검출관리', width: 12, group: 'risk' },
  ...
  const groups = [
    { name: 'D-FMEA 구조분석(2단계)', count: 4, color: COLORS.primary },
    { name: 'D-FMEA 기능분석(3단계)', count: 7, color: COLORS.secondary },
    { name: 'D-FMEA 고장분석(4단계)', count: 5, color: COLORS.danger },
    { name: 'D-FMEA 리스크분석(5단계)', count: 8, color: COLORS.primary },
    { name: 'D-FMEA 최적화(6단계)', count: 14, color: COLORS.warning },
  ];
  ...
  const subGroups = [
    ...
    { name: '2.메인공정', start: 8, end: 9, color: COLORS.secondary },
    { name: '3.작업요소', start: 10, end: 11, color: COLORS.secondary },
    ...
    { name: '예방관리', start: 17, end: 18, color: COLORS.primary },
    { name: '검출관리', start: 19, end: 20, color: COLORS.primary },
  ...
  // ★ 셀 병합 적용 (화면 그대로 재현) — 작업요소 3컬럼 제거 반영
  // FM 병합 — col 15(고장형태)
