    ...
    >
      ...
      <div className="flex items-center gap-0.5 shrink-0">
        ...
        <select
          ...
          className="px-1 py-1 rounded border-0 bg-white/20 text-white min-w-[100px] sm:min-w-[120px] lg:min-w-[140px] text-[9px] sm:text-[10px]"
        >
          {fmeaList.length === 0 ? (
      ...
      <div className="flex items-center gap-0.5 shrink-0 relative">
        ...
        >
          {isSaving ? t('저장중') : dirty ? t('저장') : 'Saved'}
        </button>
      ...
      {/* 특별특성/SOD/5AP/6AP/RPN/PDF - 중간 화면 이상 */}
