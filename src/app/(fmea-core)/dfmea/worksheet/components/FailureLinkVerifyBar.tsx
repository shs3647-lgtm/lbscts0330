...
const ITEM_DEFS: { code: string; label: string; tab: string }[] = [
  { code: 'A2', label: '공정명(Process)',       tab: '구조(Structure)' },
  { code: 'B1', label: '작업요소명(WE)',   tab: '구조(Structure)' },
  { code: 'C1', label: '구분(Category)',         tab: '기능L1(Func.)' },
  { code: 'C2', label: '완제품기능(Func.)',   tab: '기능L1(Func.)' },
  { code: 'C3', label: '요구사항(Req.)',     tab: '기능L1(Func.)' },
  { code: 'A3', label: '공정기능(Proc. Func.)',     tab: '기능L2(Func.)' },
  { code: 'A4', label: '제품특성(Prod. Char.)',     tab: '기능L2(Func.)' },
  { code: 'B2', label: '작업요소기능(WE Func.)', tab: '기능L3(Func.)' },
  { code: 'B3', label: '공정특성(Proc. Char.)',     tab: '기능L3(Func.)' },
  { code: 'C4', label: '고장영향(FE)',     tab: '고장L1(Failure)' },
  { code: 'A5', label: '고장형태(FM)',     tab: '고장L2(Failure)' },
  { code: 'B4', label: '고장원인(FC)',     tab: '고장L3(Failure)' },
  { code: 'A6', label: '검출관리(DC)',     tab: '최적화(Opt.)' },
  { code: 'B5', label: '예방관리(PC)',     tab: '최적화(Opt.)' },
];
