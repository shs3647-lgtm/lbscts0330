 ...
 * @description PFMEA 등록 - 기획 및 준비 (1단계) 폼 섹션
    ...
    <form autoComplete="off" onSubmit={(e) => e.preventDefault()}>
      <div className="bg-white rounded border border-gray-300 mb-3">
        <div className="bg-[#e3f2fd] px-3 py-1.5 border-b border-gray-300">
          <h2 className="text-xs font-bold text-gray-700" title="Planning and Preparation (Step 1)">기획 및 준비(Planning) (1단계)</h2>
        </div>
        ...
        <table className="w-full border-collapse text-xs">
          <tbody>
            ...
            <tr className="bg-[#e3f2fd] h-8">
              <td className={`${headerCell} w-[11%] whitespace-nowrap`} title="Company Name">회사 명(Company)</td>
              ...
              <td className={`${headerCell} w-[7%] whitespace-nowrap`} title="FMEA Name">FMEA명(Name)</td>
              ...
              <td className={`${headerCell} w-[8%] whitespace-nowrap`} title="Parent APQP">상위 APQP(Parent)</td>
            ...
            <tr className="bg-white h-8">
              <td className={`${headerCell} whitespace-nowrap`} title="Process Responsibility">공정 책임(Resp.)</td>
              ...
              <td className={`${headerCell} whitespace-nowrap`} title="FMEA Responsible">FMEA 담당자(Resp.)</td>
              <td className={`${inputCell}`}>
              ...
              <td className={`${headerCell} whitespace-nowrap`} title="Start Date">시작 일자(Start)</td>
              <td className={`${inputCell}`}>
                <div className="flex items-center gap-1">
                  <input
                    type="text"
              ...
              <td className={`${headerCell} whitespace-nowrap`} title="Parent FMEA">상위 FMEA(Parent)</td>
            ...
            {/* 3행 */}
            <tr className="bg-[#e3f2fd] h-8">
              <td className={`${headerCell} whitespace-nowrap`} title="Customer Name">고객 명(Customer)</td>
              <td className={`${inputCell}`}>
                <div className="flex items-center gap-1">
                  <input
                    type="text"
              ...
              <td className={`${headerCell} whitespace-nowrap`} title="Revision Date">개정 일자(Rev. Date)</td>
              <td className={`${inputCell}`}>
                <div className="flex items-center gap-1">
                  <input
                    type="text"
              ...
              <td className={`${headerCell} whitespace-nowrap`} title="Engineering Location">엔지니어링 위치(Location)</td>
              <td className={`${inputCell}`}>
                <input
                  type="text"
              ...
              <td className={`${headerCell} whitespace-nowrap`} title="Confidentiality Level">보안 수준(Confidential)</td>
              <td className={`${inputCell}`}>
                <select
      ...
      <div className="bg-white rounded border border-gray-300 mb-3 p-3">
        <div className="flex items-center gap-2 mb-2">
          ...
          <h3 className="text-xs font-bold text-gray-700" title="Basic Info Registration Options">기초정보 등록 옵션(Basic Info Options)</h3>
        </div>
