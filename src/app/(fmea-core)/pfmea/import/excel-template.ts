...
const SAMPLE_DATA: Record<string, string[][]> = {
  ...
  // v5.9: A6 검출관리 — Au BUMP 공정 (3요소: 장비명+검사방법+빈도)
  'L2-6(A6) 검출관리': [
    ['01', '파티클 카운터 실시간 모니터링, 매lot 전수'],
    ['10', 'Wafer 두께 측정기 전수검사, 매lot'],
    ['20', '비전 센서 정렬 전수 확인'], ['30', 'KLA 파티클 카운터 전수검사'],
    ['40', 'SEM 전수검사, 4-Point Probe 매lot 측정'], ['50', 'KLA 파티클 카운터 전수검사'],
    ['60', '막두께 측정기 전수검사'], ['70', 'CD SEM 전수측정'],
    ['80', '광학현미경 샘플링 검사'], ['90', '광학현미경 샘플링 검사'],
    ['100', '높이 측정기 전수검사, 외관 샘플링 검사'], ['100', 'XRF 분석기 매lot 분석'],
    ['110', '광학현미경 샘플링 검사'],
    ['120', 'SEM 전수검사'], ['130', 'SEM 전수검사'],
    ['140', 'Cross-section SEM 샘플링 검사'],
    ['150', 'AVI 자동외관 전수검사'], ['150', '높이 측정기 전수검사'],
    ['160', 'KLA 파티클 카운터 전수검사'], ['170', 'KLA 파티클 카운터 전수검사'],
    ['180', '비전 센서 정렬 전수 확인'], ['190', 'AVI 전수 이중검사'],
    ['200', '포장 체크리스트 전수 확인'],
  ],

  // ═══════════════════════════════════════════════════════════════
  // B계열: L3 작업요소 레벨 — v5.8: 개별시트 데이터 삭제, L3통합이 유일한 소스
  // ═══════════════════════════════════════════════════════════════
  // ★ B1-B5 개별시트 SAMPLE_DATA 제거 (2026-03-14)
  // 사유: 개별시트 + L3통합 동시 존재 시 파서가 개별(OVERWRITE) → 통합(ADD)으로
  //       동일 데이터 2배 생성. B5는 추가로 valStartCol=3이 작업요소 컬럼을 읽어 값=0.
  // 해결: L3통합(B1-B5) 시트만 SAMPLE_DATA 유지 → 단일 소스, 중복 제거.
  // 개별시트 헤더는 유지(빈 데이터) → 사용자가 직접 입력 가능.
  ...
  'FC 고장사슬': [
    ...
    ['YP', 'Wafer 표면 결함 미검출로 인한 후공정 유출', '10', 'TTV 규격 초과', 'IM', 'Wafer', '자재 품질 부적합', 'IQC COA 규격 관리, 입고 기준 강화', 'Wafer 두께 측정기 전수검사, 매lot', '3', '3', 'L'],
    // ── 공정 20: Sorter ──
    ...
    ['YP', 'Particle 오염으로 인한 제품 특성 이상', '30', '세정 불량', 'IM', 'DI Water', 'DI Water 비저항 저하', 'DI Water 비저항 실시간 모니터링', 'KLA 파티클 카운터 전수검사', '3', '3', 'L'],
    // ── 공정 40: UBM Sputter ──
    ['YP', '전기적 Open/Short', '40', 'UBM 두께 부족', 'MC', 'Sputter 장비', 'Power 변동', 'Sputter 장비 PM, Power 실시간 모니터링', 'SEM 전수검사, 4-Point Probe 매lot 측정', '3', '4', 'M'],
    ['YP', '전기적 Open/Short', '40', 'UBM 두께 부족', 'MC', 'DC Power Supply', '전압 변동', '정기 교정, UPS 운용', 'SEM 전수검사, 4-Point Probe 매lot 측정', '3', '4', 'M'],
    ['YP', 'Bump Lift-off', '40', 'UBM 두께 부족', 'EN', '진공 챔버', '진공 누설', '진공도 실시간 모니터링, Leak 점검', 'SEM 전수검사, 4-Point Probe 매lot 측정', '3', '4', 'M'],
    ['YP', '전기적 Open/Short', '40', '막질 불균일', 'IM', 'Ti Target', 'Target 소진', 'Target 사용량 카운터 관리', 'SEM 전수검사, 4-Point Probe 매lot 측정', '4', '4', 'M'],
    ['YP', '전기적 Open/Short', '40', '막질 불균일', 'IM', 'Cu Target', 'Target 소진', 'Target 사용량 카운터 관리', 'SEM 전수검사, 4-Point Probe 매lot 측정', '4', '4', 'M'],
    // ── 공정 50: Scrubber2 ──
    ...
    ['YP', 'PR 두께 Spec Out으로 인한 패턴 불량', '60', 'PR 두께 불균일', 'IM', 'PR(Photo Resist)', 'PR 열화', 'PR 유효기한 관리, 냉장보관', '막두께 측정기 전수검사', '3', '4', 'M'],
    // ── 공정 70: Exposure ──
    ['YP', 'Bump간 Bridge', '70', 'CD 규격 이탈', 'MC', 'Stepper/Scanner', '에너지 편차', 'Stepper 정기 교정, 에너지 실시간 모니터링', 'CD SEM 전수측정', '3', '3', 'M'],
    ['YP', 'Bump간 Bridge', '70', 'CD 규격 이탈', 'IM', 'Mask(Reticle)', 'Mask 결함', 'Mask 정기 세정, 결함 관리', 'CD SEM 전수측정', '3', '3', 'L'],
    // ── 공정 80: Develop ──
    ['YP', 'CD Spec Out으로 인한 Bump 형성 불량', '80', 'Under/Over develop', 'MC', 'Developer', '현상 시간 편차', 'Developer PM, 시간 자동제어', '광학현미경 샘플링 검사', '3', '4', 'M'],
    ['YP', 'CD Spec Out으로 인한 Bump 형성 불량', '80', 'Under/Over develop', 'IM', '현상액', '농도 편차', '농도 자동 보정 시스템', '광학현미경 샘플링 검사', '3', '4', 'M'],
    // ── 공정 90: Descum ──
    ...
    ['YP', '전기적 Open/Short', '100', '높이 편차', 'MC', '정류기(Rectifier)', '전류 변동', '정류기 정기 교정', '높이 측정기 전수검사, 외관 샘플링 검사', '3', '4', 'M'],
    ...
    ['SP', 'IMC 과성장에 의한 접합부 열화', '140', 'IMC 과성장', 'EN', 'N₂ 공급장치', '유량 부족', 'N₂ 유량 실시간 모니터링', 'Cross-section SEM 샘플링 검사', '3', '4', 'M'],
    ...
    ['USER', '고객 신뢰도 하락', '150', '외관 불량', 'MN', '검사원', '판정 기준 오적용', '검사원 정기 교육, 한도 견본 비치', 'AVI 자동외관 전수검사', '3', '3', 'M'],
    // ── 공정 160: Clean ──
    ...
    // ★ v5.9: MN/IM/EN 누락 FC 56건 추가 — 전 공정 4M 전수 커버
    // ── 공정 01: 작업환경 (MN/IM/EN 추가) ──
    ['YP', 'Particle 오염으로 인한 제품 특성 이상', '01', '파티클 초과', 'MC', '항온항습기', '설비 가동률 저하', '항온항습기 PM Table 등록 + 월 1회 PM 이행 점검', '파티클 카운터 실시간 모니터링, 매lot 전수', '3', '4', 'L'],
    ['YP', 'Particle 오염으로 인한 제품 특성 이상', '01', '파티클 초과', 'MN', '클린룸 담당자', '작업 숙련도 부족', '환경관리 담당자 정기 숙련도 평가 + 작업표준 교육', '파티클 카운터 실시간 모니터링, 매lot 전수', '3', '5', 'L'],
    ['YP', 'Particle 오염으로 인한 제품 특성 이상', '01', '파티클 초과', 'IM', '필터 소모품', '자재 품질 부적합', '필터 소모품 수입검사 강화 + 유효기한 관리', '파티클 카운터 실시간 모니터링, 매lot 전수', '3', '4', 'L'],
    ['YP', 'Particle 오염으로 인한 제품 특성 이상', '01', '파티클 초과', 'EN', '클린룸', '온습도 제어 이탈', '항온항습기 자동제어, 일상점검', '파티클 카운터 실시간 모니터링, 매lot 전수', '3', '5', 'L'],
    // ── 공정 10: IQA (MN/EN 추가) ──
    ['YP', 'Wafer 표면 결함 미검출로 인한 후공정 유출', '10', '두께 규격 이탈', 'MN', '검사원', '판정 기준 오적용', '검사원 정기 교육', 'Wafer 두께 측정기 전수검사, 매lot', '3', '5', 'L'],
    ['YP', 'Wafer 표면 결함 미검출로 인한 후공정 유출', '10', '두께 규격 이탈', 'EN', '검사실', '환경 조건 이탈', '검사실 실시간 모니터링 + 일상점검', 'Wafer 두께 측정기 전수검사, 매lot', '3', '5', 'L'],
    // ── 공정 20: Sorter (MN/IM/EN 추가) ──
    ['YP', 'Lot 혼입으로 인한 Wafer 수율 손실', '20', '정렬 불량', 'MN', 'Sorter 작업자', '작업 숙련도 부족', 'Sorter 작업자 정기 숙련도 평가 + 작업표준 교육', '비전 센서 정렬 전수 확인', '3', '5', 'L'],
    ['YP', 'Lot 혼입으로 인한 Wafer 수율 손실', '20', '정렬 불량', 'IM', 'Wafer Cassette', '자재 품질 부적합', 'Wafer Cassette 수입검사 강화 + 유효기한 관리', '비전 센서 정렬 전수 확인', '3', '4', 'L'],
    ['YP', 'Lot 혼입으로 인한 Wafer 수율 손실', '20', '정렬 불량', 'EN', 'Sorter 작업영역', '환경 조건 이탈', 'Sorter 작업영역 실시간 모니터링 + 일상점검', '비전 센서 정렬 전수 확인', '3', '5', 'L'],
    // ── 공정 30: Scrubber (MN/EN 추가) ──
    ['YP', 'Particle 오염으로 인한 제품 특성 이상', '30', '세정 불량', 'MN', 'Scrubber 작업자', '작업 숙련도 부족', 'Scrubber 작업자 정기 숙련도 평가 + 작업표준 교육', 'KLA 파티클 카운터 전수검사', '3', '5', 'L'],
    ['YP', 'Particle 오염으로 인한 제품 특성 이상', '30', '세정 불량', 'EN', 'Scrubber 작업영역', '환경 조건 이탈', 'Scrubber 작업영역 실시간 모니터링 + 일상점검', 'KLA 파티클 카운터 전수검사', '3', '5', 'L'],
    // ── 공정 40: UBM Sputter (MN 추가) ──
    ['YP', '전기적 Open/Short', '40', 'UBM 두께 부족', 'MN', 'Sputter 작업자', '작업 숙련도 부족', 'Sputter 작업자 정기 숙련도 평가 + 작업표준 교육', 'SEM 전수검사, 4-Point Probe 매lot 측정', '3', '5', 'L'],
    // ── 공정 50: Scrubber2 (MN/IM/EN 추가) ──
    ['YP', 'Particle 오염으로 인한 제품 특성 이상', '50', '세정 불량', 'MN', 'Scrubber2 작업자', '작업 숙련도 부족', 'Scrubber2 작업자 정기 숙련도 평가 + 작업표준 교육', 'KLA 파티클 카운터 전수검사', '3', '5', 'L'],
    ['YP', 'Particle 오염으로 인한 제품 특성 이상', '50', '세정 불량', 'IM', 'DI Water', 'DI Water 비저항 저하', 'DI Water 수입검사 강화 + 유효기한 관리', 'KLA 파티클 카운터 전수검사', '3', '4', 'L'],
    ['YP', 'Particle 오염으로 인한 제품 특성 이상', '50', '세정 불량', 'EN', 'Scrubber2 작업영역', '환경 조건 이탈', 'Scrubber2 작업영역 실시간 모니터링 + 일상점검', 'KLA 파티클 카운터 전수검사', '3', '5', 'L'],
    // ── 공정 60: PR Coating (MN/EN 추가) ──
    ['YP', 'PR 두께 Spec Out으로 인한 패턴 불량', '60', 'PR 두께 불균일', 'MN', 'Coating 작업자', '작업 숙련도 부족', 'Coating 작업자 정기 숙련도 평가 + 작업표준 교육', '막두께 측정기 전수검사', '3', '5', 'L'],
    ['YP', 'PR 두께 Spec Out으로 인한 패턴 불량', '60', 'PR 두께 불균일', 'EN', 'Yellow Room', '환경 조건 이탈', 'Yellow Room 실시간 모니터링 + 일상점검', '막두께 측정기 전수검사', '3', '5', 'L'],
    // ── 공정 70: Exposure (MN/EN 추가) ──
    ['YP', 'Bump간 Bridge', '70', 'CD 규격 이탈', 'MN', 'Exposure 작업자', '작업 숙련도 부족', 'Exposure 작업자 정기 숙련도 평가 + 작업표준 교육', 'CD SEM 전수측정', '3', '5', 'L'],
    ['YP', 'Bump간 Bridge', '70', 'CD 규격 이탈', 'EN', 'Exposure 챔버', '환경 조건 이탈', 'Exposure 챔버 실시간 모니터링 + 일상점검', 'CD SEM 전수측정', '3', '5', 'L'],
    // ── 공정 80: Develop (MN/EN 추가) ──
    ['YP', 'CD Spec Out으로 인한 Bump 형성 불량', '80', 'Under/Over develop', 'MN', 'Develop 작업자', '작업 숙련도 부족', 'Develop 작업자 정기 숙련도 평가 + 작업표준 교육', '광학현미경 샘플링 검사', '3', '5', 'L'],
    ['YP', 'CD Spec Out으로 인한 Bump 형성 불량', '80', 'Under/Over develop', 'EN', 'Develop 작업영역', '환경 조건 이탈', 'Develop 작업영역 실시간 모니터링 + 일상점검', '광학현미경 샘플링 검사', '3', '5', 'L'],
    // ── 공정 90: Descum (MN/IM/EN 추가) ──
    ['YP', 'PR Scum 잔류로 인한 Au Bump 형성 불량', '90', 'PR 잔사 잔류', 'MN', 'Descum 작업자', '작업 숙련도 부족', 'Descum 작업자 정기 숙련도 평가 + 작업표준 교육', '광학현미경 샘플링 검사', '3', '5', 'L'],
    ['YP', 'PR Scum 잔류로 인한 Au Bump 형성 불량', '90', 'PR 잔사 잔류', 'IM', 'O₂ Gas', '자재 품질 부적합', 'O₂ Gas 수입검사 강화 + 유효기한 관리', '광학현미경 샘플링 검사', '3', '4', 'L'],
    ['YP', 'PR Scum 잔류로 인한 Au Bump 형성 불량', '90', 'PR 잔사 잔류', 'EN', 'Descum 챔버', '환경 조건 이탈', 'Descum 챔버 실시간 모니터링 + 일상점검', '광학현미경 샘플링 검사', '3', '5', 'L'],
    // ── 공정 100: Au Plating (MN/EN 추가) ──
    ['YP', '전기적 Open/Short', '100', '높이 편차', 'MN', 'Plating 작업자', '작업 숙련도 부족', 'Plating 작업자 정기 숙련도 평가 + 작업표준 교육', '높이 측정기 전수검사, 외관 샘플링 검사', '3', '5', 'L'],
    ['YP', '전기적 Open/Short', '100', '높이 편차', 'EN', 'Plating 작업영역', '환경 조건 이탈', 'Plating 작업영역 실시간 모니터링 + 일상점검', '높이 측정기 전수검사, 외관 샘플링 검사', '3', '5', 'L'],
    // ── 공정 110: PR Strip (MN/IM/EN 추가) ──
    ['YP', 'Bump Height Spec Out으로 인한 제품 특성 이상', '110', 'PR 잔사 잔류', 'MN', 'Strip 작업자', '작업 숙련도 부족', 'Strip 작업자 정기 숙련도 평가 + 작업표준 교육', '광학현미경 샘플링 검사', '3', '5', 'L'],
    ['YP', 'Bump Height Spec Out으로 인한 제품 특성 이상', '110', 'PR 잔사 잔류', 'IM', 'Strip 용제', '자재 품질 부적합', 'Strip 용제 수입검사 강화 + 유효기한 관리', '광학현미경 샘플링 검사', '3', '4', 'L'],
    ['YP', 'Bump Height Spec Out으로 인한 제품 특성 이상', '110', 'PR 잔사 잔류', 'EN', 'Strip 작업영역', '환경 조건 이탈', 'Strip 작업영역 실시간 모니터링 + 일상점검', '광학현미경 샘플링 검사', '3', '5', 'L'],
    // ── 공정 120: Au Etch (MN/IM/EN 추가) ──
    ['YP', 'Plating 균일도 Spec Out으로 인한 Bump 특성 이상', '120', '에칭 부족/과다', 'MN', 'Etch 작업자', '작업 숙련도 부족', 'Etch 작업자 정기 숙련도 평가 + 작업표준 교육', 'SEM 전수검사', '3', '5', 'L'],
    ['YP', 'Plating 균일도 Spec Out으로 인한 Bump 특성 이상', '120', '에칭 부족/과다', 'IM', 'Au Etchant', '자재 품질 부적합', 'Au Etchant 수입검사 강화 + 유효기한 관리', 'SEM 전수검사', '3', '4', 'L'],
    ['YP', 'Plating 균일도 Spec Out으로 인한 Bump 특성 이상', '120', '에칭 부족/과다', 'EN', 'Etch 작업영역', '환경 조건 이탈', 'Etch 작업영역 실시간 모니터링 + 일상점검', 'SEM 전수검사', '3', '5', 'L'],
    // ── 공정 130: TiW Etch (MN/IM/EN 추가) ──
    ['YP', 'Plating 균일도 Spec Out으로 인한 Bump 특성 이상', '130', 'Under/Over etch', 'MN', 'TiW Etch 작업자', '작업 숙련도 부족', 'TiW Etch 작업자 정기 숙련도 평가 + 작업표준 교육', 'SEM 전수검사', '3', '5', 'L'],
    ['YP', 'Plating 균일도 Spec Out으로 인한 Bump 특성 이상', '130', 'Under/Over etch', 'IM', 'TiW Etchant', '자재 품질 부적합', 'TiW Etchant 수입검사 강화 + 유효기한 관리', 'SEM 전수검사', '3', '4', 'L'],
    ['YP', 'Plating 균일도 Spec Out으로 인한 Bump 특성 이상', '130', 'Under/Over etch', 'EN', 'TiW Etch 작업영역', '환경 조건 이탈', 'TiW Etch 작업영역 실시간 모니터링 + 일상점검', 'SEM 전수검사', '3', '5', 'L'],
    // ── 공정 140: Anneal (MN/IM 추가) ──
    ['SP', 'IMC 과성장에 의한 접합부 열화', '140', 'IMC 과성장', 'MN', 'Anneal 작업자', '작업 숙련도 부족', 'Anneal 작업자 정기 숙련도 평가 + 작업표준 교육', 'Cross-section SEM 샘플링 검사', '3', '5', 'L'],
    ['SP', 'IMC 과성장에 의한 접합부 열화', '140', 'IMC 과성장', 'IM', 'N₂ Gas', '자재 품질 부적합', 'N₂ Gas 수입검사 강화 + 유효기한 관리', 'Cross-section SEM 샘플링 검사', '3', '4', 'L'],
    // ── 공정 150: Final Inspection (IM/EN 추가) ──
    ['USER', '고객 라인 정지, 클레임', '150', '외관 불량', 'IM', '한도 견본', '자재 품질 부적합', '한도 견본 수입검사 강화 + 유효기한 관리', 'AVI 자동외관 전수검사', '3', '4', 'L'],
    ['USER', '고객 라인 정지, 클레임', '150', '외관 불량', 'EN', '검사실', '환경 조건 이탈', '검사실 실시간 모니터링 + 일상점검', 'AVI 자동외관 전수검사', '3', '5', 'L'],
    // ── 공정 160: Clean (MN/IM/EN 추가) ──
    ['SP', 'Particle 오염 불량 유출로 인한 고객 기능 이상', '160', '세정 불량', 'MN', 'Clean 작업자', '작업 숙련도 부족', 'Clean 작업자 정기 숙련도 평가 + 작업표준 교육', 'KLA 파티클 카운터 전수검사', '3', '5', 'L'],
    ['SP', 'Particle 오염 불량 유출로 인한 고객 기능 이상', '160', '세정 불량', 'IM', 'DI Water', '자재 품질 부적합', 'DI Water 수입검사 강화 + 유효기한 관리', 'KLA 파티클 카운터 전수검사', '3', '4', 'L'],
    ['SP', 'Particle 오염 불량 유출로 인한 고객 기능 이상', '160', '세정 불량', 'EN', 'Clean 작업영역', '환경 조건 이탈', 'Clean 작업영역 실시간 모니터링 + 일상점검', 'KLA 파티클 카운터 전수검사', '3', '5', 'L'],
    // ── 공정 170: Scrubber3 (MN/IM/EN 추가) ──
    ['SP', 'Particle 오염 불량 유출로 인한 고객 기능 이상', '170', '세정 불량', 'MN', 'Scrubber3 작업자', '작업 숙련도 부족', 'Scrubber3 작업자 정기 숙련도 평가 + 작업표준 교육', 'KLA 파티클 카운터 전수검사', '3', '5', 'L'],
    ['SP', 'Particle 오염 불량 유출로 인한 고객 기능 이상', '170', '세정 불량', 'IM', 'DI Water', '자재 품질 부적합', 'DI Water 수입검사 강화 + 유효기한 관리', 'KLA 파티클 카운터 전수검사', '3', '4', 'L'],
    ['SP', 'Particle 오염 불량 유출로 인한 고객 기능 이상', '170', '세정 불량', 'EN', 'Scrubber3 작업영역', '환경 조건 이탈', 'Scrubber3 작업영역 실시간 모니터링 + 일상점검', 'KLA 파티클 카운터 전수검사', '3', '5', 'L'],
    // ── 공정 180: Sorter3 (MN/IM/EN 추가) ──
    ['SP', '라벨 불일치로 인한 Lot 혼입 불량 유출', '180', '정렬 불량', 'MN', 'Sorter3 작업자', '작업 숙련도 부족', 'Sorter3 작업자 정기 숙련도 평가 + 작업표준 교육', '비전 센서 정렬 전수 확인', '3', '5', 'L'],
    ['SP', '라벨 불일치로 인한 Lot 혼입 불량 유출', '180', '정렬 불량', 'IM', 'Wafer Cassette', '자재 품질 부적합', 'Wafer Cassette 수입검사 강화 + 유효기한 관리', '비전 센서 정렬 전수 확인', '3', '4', 'L'],
    ['SP', '라벨 불일치로 인한 Lot 혼입 불량 유출', '180', '정렬 불량', 'EN', 'Sorter3 작업영역', '환경 조건 이탈', 'Sorter3 작업영역 실시간 모니터링 + 일상점검', '비전 센서 정렬 전수 확인', '3', '5', 'L'],
    // ── 공정 190: AVI (MN/IM/EN 추가) ──
    ['SP', '외관 결함 불량 유출(고객 Outgoing Defect)', '190', '외관 결함 미검출', 'MN', 'AVI 작업자', '작업 숙련도 부족', 'AVI 작업자 정기 숙련도 평가 + 작업표준 교육', 'AVI 전수 이중검사', '3', '5', 'L'],
    ['SP', '외관 결함 불량 유출(고객 Outgoing Defect)', '190', '외관 결함 미검출', 'IM', '한도 견본', '자재 품질 부적합', '한도 견본 수입검사 강화 + 유효기한 관리', 'AVI 전수 이중검사', '3', '4', 'L'],
    ['SP', '외관 결함 불량 유출(고객 Outgoing Defect)', '190', '외관 결함 미검출', 'EN', 'AVI 작업영역', '환경 조건 이탈', 'AVI 작업영역 실시간 모니터링 + 일상점검', 'AVI 전수 이중검사', '3', '5', 'L'],
    // ── 공정 200: OGI/Packing (MN/IM/EN 추가) ──
    ['SP', '고객 Packing 기준 부적합으로 인한 납품 Reject', '200', '포장 불량', 'MN', '포장 작업자', '체크리스트 누락', '출하 체크리스트 교육', '포장 체크리스트 전수 확인', '3', '5', 'L'],
    ['SP', '고객 Packing 기준 부적합으로 인한 납품 Reject', '200', '포장 불량', 'IM', '포장재', '자재 품질 부적합', '포장재 수입검사 강화 + 유효기한 관리', '포장 체크리스트 전수 확인', '3', '4', 'L'],
    ['SP', '고객 Packing 기준 부적합으로 인한 납품 Reject', '200', '포장 불량', 'EN', '포장 작업영역', '환경 조건 이탈', '포장 작업영역 실시간 모니터링 + 일상점검', '포장 체크리스트 전수 확인', '3', '5', 'L'],
  ],
  ...
  // ═══════════════════════════════════════════════════════════════
  // 통합시트 샘플 데이터 — v5.8: L3통합만 유지 (L1/L2통합 제거)
  // 사유: 개별시트 + 통합시트 동시 존재 시 동일 데이터 2배 생성
  // A계열(A1-A6): 개별시트가 유일한 소스
  // B계열(B1-B5): L3통합이 유일한 소스 (B5 4-column 파싱 이슈 회피)
  // C계열(C1-C4): 개별시트가 유일한 소스
  // ═══════════════════════════════════════════════════════════════
  ...
  'L3 통합(B1-B5)': [
    ...
    ['01', 'MN', '클린룸 담당자', '환경관리 담당자가 클린룸 환경 기준을 확인하고 적합 여부를 판정한다', '작업 숙련도', '', '작업 숙련도 부족', '환경관리 담당자 정기 숙련도 평가 + 작업표준 교육'],
    ...
    ['180', 'IM', 'Wafer Cassette', 'Wafer Cassette가 Wafer 운반·보호 기능을 제공한다', '자재 규격', '', '자재 품질 부적합', 'Wafer Cassette 수입검사 강화 + 유효기한 관리'],
