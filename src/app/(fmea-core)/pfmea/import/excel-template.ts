...
const SAMPLE_DATA: Record<string, string[][]> = {
  ...
  'L3-3(B3) 공정특성': [
    ...
    ['70', 'MC', 'Stepper/Scanner', '노광 에너지', 'CC'],
    ...
    ['100', 'MC', 'Au Plating Tank', '전류밀도', 'CC'],
  ...
  'L3-5(B5) 예방관리': [
    ...
    ['180', 'MC', 'Sorter 장비', 'Wafer Cassette 수입검사 강화 + 유효기한 관리'],
    ['180', 'IM', 'Wafer Cassette', 'Sorter3 작업영역 실시간 모니터링 + 일상점검'],
    ['190', 'MN', 'AVI 작업자', 'AVI 정기 교정'],
    ['190', 'MC', 'AVI 장비', 'AVI 작업자 정기 숙련도 평가 + 작업표준 교육'],
    ['190', 'IM', '한도 견본', '한도 견본 수입검사 강화 + 유효기한 관리'],
    ['190', 'EN', 'AVI 작업영역', 'AVI 작업영역 실시간 모니터링 + 일상점검'],
    ['200', 'MN', '포장 작업자', '포장 장비 PM'],
    ['200', 'MC', '포장 장비', '출하 체크리스트 교육'],
    ['200', 'IM', '포장재', '포장재 수입검사 강화 + 유효기한 관리'],
    ['200', 'EN', '포장 작업영역', '포장 작업영역 실시간 모니터링 + 일상점검'],
    ['01', 'EN', '클린룸', 'FFU 풍속 정기점검'],
    ['01', 'MC', '항온항습기', '항온항습기 PM Table 등록 + 월 1회 PM 이행 점검'],
    ['01', 'MN', '클린룸 담당자', '환경관리 담당자 정기 숙련도 평가 + 작업표준 교육'],
    ['01', 'IM', '필터 소모품', '필터 소모품 수입검사 강화 + 유효기한 관리'],
    ['01', 'EN', '클린룸', '항온항습기 자동제어, 일상점검'],
    ['01', 'MN', '클린룸 담당자', '항온항습기 PM Table 등록 + 월 1회 PM 이행 점검'],
    ['01', 'MC', '항온항습기', '환경관리 담당자 정기 숙련도 평가 + 작업표준 교육'],
    ['01', 'IM', '필터 소모품', '필터 소모품 수입검사 강화 + 유효기한 관리'],
    ['01', 'EN', '클린룸', '항온항습기 자동제어, 일상점검'],
    ['01', 'EN', '클린룸', 'FFU 풍속 정기점검'],
    ['10', 'MN', '검사원', '측정기 정기 교정(MSA)'],
    ['10', 'MC', '두께 측정기', '검사원 정기 교육'],
    ['10', 'IM', 'Wafer', '수입검사 강화, IQC COA 확인'],
    ['10', 'EN', '검사실', '검사실 실시간 모니터링 + 일상점검'],
    ['20', 'MN', 'Sorter 작업자', 'Sorter 일상점검, 센서 교정'],
    ['20', 'MC', 'Sorter 장비', 'Sorter 작업자 정기 숙련도 평가 + 작업표준 교육'],
    ['20', 'IM', 'Wafer Cassette', 'Wafer Cassette 수입검사 강화 + 유효기한 관리'],
    ['20', 'EN', 'Sorter 작업영역', 'Sorter 작업영역 실시간 모니터링 + 일상점검'],
    ['30', 'MN', 'Scrubber 작업자', 'Scrubber PM(예방보전)'],
    ['30', 'MC', 'Scrubber 장비', 'Scrubber 작업자 정기 숙련도 평가 + 작업표준 교육'],
    ['30', 'IM', 'DI Water', 'DI Water 비저항 실시간 모니터링'],
    ['30', 'EN', 'Scrubber 작업영역', 'Scrubber 작업영역 실시간 모니터링 + 일상점검'],
    ['40', 'MN', 'Sputter 작업자', 'Sputter 장비 PM, Power 실시간 모니터링'],
    ['40', 'MC', 'Sputter 장비', '정기 교정, UPS 운용'],
    ['40', 'MC', 'Sputter 장비', 'Sputter 작업자 정기 숙련도 평가 + 작업표준 교육'],
    ['40', 'IM', 'Ti Target', 'Target 사용량 카운터 관리'],
    ['40', 'IM', 'Ti Target', '진공도 실시간 모니터링, Leak 점검'],
    ['50', 'MN', 'Scrubber2 작업자', 'Scrubber PM(예방보전)'],
    ['50', 'MC', 'Scrubber 장비', 'Scrubber2 작업자 정기 숙련도 평가 + 작업표준 교육'],
    ['50', 'IM', 'DI Water', 'DI Water 수입검사 강화 + 유효기한 관리'],
    ['50', 'EN', 'Scrubber2 작업영역', 'Scrubber2 작업영역 실시간 모니터링 + 일상점검'],
    ['60', 'MN', 'Coating 작업자', 'Coater PM, RPM 실시간 모니터링'],
    ['60', 'MC', 'Coater', 'Coating 작업자 정기 숙련도 평가 + 작업표준 교육'],
    ['60', 'IM', 'PR(Photo Resist)', 'PR 유효기한 관리, 냉장보관'],
    ['60', 'EN', 'Yellow Room', 'Yellow Room 실시간 모니터링 + 일상점검'],
    ['70', 'MN', 'Exposure 작업자', 'Stepper 정기 교정, 에너지 실시간 모니터링'],
    ['70', 'MC', 'Stepper/Scanner', 'Exposure 작업자 정기 숙련도 평가 + 작업표준 교육'],
    ['70', 'IM', 'Mask(Reticle)', 'Mask 정기 세정, 결함 관리'],
    ['70', 'EN', 'Exposure 챔버', 'Exposure 챔버 실시간 모니터링 + 일상점검'],
    ['80', 'MN', 'Develop 작업자', 'Developer PM, 시간 자동제어'],
    ['80', 'MC', 'Developer', 'Develop 작업자 정기 숙련도 평가 + 작업표준 교육'],
    ['80', 'IM', '현상액', '농도 자동 보정 시스템'],
    ['80', 'EN', 'Develop 작업영역', 'Develop 작업영역 실시간 모니터링 + 일상점검'],
    ['90', 'MN', 'Descum 작업자', 'Descum PM, Power 모니터링'],
    ['90', 'MC', 'Descum 장비', 'Descum 작업자 정기 숙련도 평가 + 작업표준 교육'],
    ['90', 'IM', 'O₂ Gas', 'O₂ Gas 수입검사 강화 + 유효기한 관리'],
    ['90', 'EN', 'Descum 챔버', 'Descum 챔버 실시간 모니터링 + 일상점검'],
    ['100', 'MN', 'Plating 작업자', 'Plating Tank PM, 전류밀도 자동제어'],
    ['100', 'MC', 'Au Plating Tank', '정류기 정기 교정'],
    ['100', 'MC', 'Au Plating Tank', 'Plating 작업자 정기 숙련도 평가 + 작업표준 교육'],
    ['100', 'IM', 'Au 도금액', '도금액 농도 자동분석, 보충'],
    ['100', 'EN', 'Plating 작업영역', 'Plating 작업영역 실시간 모니터링 + 일상점검'],
    ['110', 'MN', 'Strip 작업자', 'Strip 장비 PM, 온도 자동제어'],
    ['110', 'MC', 'Strip 장비', 'Strip 작업자 정기 숙련도 평가 + 작업표준 교육'],
    ['110', 'IM', 'Strip 용제', 'Strip 용제 수입검사 강화 + 유효기한 관리'],
    ['110', 'EN', 'Strip 작업영역', 'Strip 작업영역 실시간 모니터링 + 일상점검'],
    ['120', 'MN', 'Etch 작업자', 'Etch PM, 시간 자동제어'],
    ['120', 'MC', 'Etch 장비', 'Etch 작업자 정기 숙련도 평가 + 작업표준 교육'],
    ['120', 'IM', 'Au Etchant', 'Au Etchant 수입검사 강화 + 유효기한 관리'],
    ['120', 'EN', 'Etch 작업영역', 'Etch 작업영역 실시간 모니터링 + 일상점검'],
    ['130', 'MN', 'TiW Etch 작업자', 'Etch PM, 온도 자동제어'],
    ['130', 'MC', 'TiW Etch 장비', 'TiW Etch 작업자 정기 숙련도 평가 + 작업표준 교육'],
    ['130', 'IM', 'TiW Etchant', 'TiW Etchant 수입검사 강화 + 유효기한 관리'],
    ['130', 'EN', 'TiW Etch 작업영역', 'TiW Etch 작업영역 실시간 모니터링 + 일상점검'],
    ['140', 'MN', 'Anneal 작업자', 'Anneal 장비 PM, 온도 프로파일 모니터링'],
    ['140', 'MC', 'Anneal 장비', 'Anneal 작업자 정기 숙련도 평가 + 작업표준 교육'],
    ['140', 'IM', 'N₂ Gas', 'N₂ Gas 수입검사 강화 + 유효기한 관리'],
    ['140', 'EN', 'N₂ 공급장치', 'N₂ 유량 실시간 모니터링'],
    ['150', 'MN', '검사원', 'AVI 정기 교정, 한도 견본 검증'],
    ['150', 'MC', 'AVI 장비', '측정기 정기 교정(MSA)'],
    ['150', 'MC', 'AVI 장비', '검사원 정기 교육, 한도 견본 비치'],
    ['150', 'IM', '한도 견본', '한도 견본 수입검사 강화 + 유효기한 관리'],
    ['150', 'EN', '검사실', '검사실 실시간 모니터링 + 일상점검'],
    ['160', 'MN', 'Clean 작업자', 'Clean 장비 PM'],
    ['160', 'MC', 'Clean 장비', 'Clean 작업자 정기 숙련도 평가 + 작업표준 교육'],
    ['160', 'IM', 'DI Water', 'DI Water 수입검사 강화 + 유효기한 관리'],
    ['160', 'EN', 'Clean 작업영역', 'Clean 작업영역 실시간 모니터링 + 일상점검'],
    ['170', 'MN', 'Scrubber3 작업자', 'Scrubber PM'],
    ['170', 'MC', 'Scrubber 장비', 'Scrubber3 작업자 정기 숙련도 평가 + 작업표준 교육'],
    ['170', 'IM', 'DI Water', 'DI Water 수입검사 강화 + 유효기한 관리'],
    ['170', 'EN', 'Scrubber3 작업영역', 'Scrubber3 작업영역 실시간 모니터링 + 일상점검'],
    ['180', 'EN', 'Sorter3 작업영역', 'Sorter 일상점검'],
  ],
  // ═══════════════════════════════════════════════════════════════
  // C계열: L1 완제품 레벨
  // ═══════════════════════════════════════════════════════════════
  ...
  'L1 통합(C1-C4)': [
    ...
    ['SP', 'Au Bump 전단강도 및 높이가 고객 규격을 만족하는 Wafer를 제공한다', 'Au Bump 높이(Bump Height, μm) — CC', 'Lot 혼입 불량 유출(고객 불량 수령)'],
    ['SP', '외관 결함이 없고 고객 Packing 기준에 맞게 포장된 Wafer를 제공한다', 'Au Bump 전단강도(Shear Strength, gf) — CC', '외관 결함 불량 유출(고객 Outgoing Defect)'],
  ...
  'L2 통합(A1-A6)': [
    ...
    ['10', 'IQA(수입검사)', '입고 자재의 품질을 확인하여 불량 자재 유입을 방지한다', 'Wafer TTV', 'CC', 'TTV 규격 초과', 'Wafer 두께 측정기 전수검사, 매lot'],
    ...
    ['40', 'UBM Sputter', 'Ti/Cu UBM 증착으로 Bump 접합층을 형성한다', 'UBM 두께', 'CC', 'UBM 두께 부족', 'SEM 전수검사, 4-Point Probe 매lot 측정'],
    ...
    ['70', 'Exposure', 'PR을 노광하여 Bump 패턴을 전사한다', 'CD(Critical Dimension)', 'CC', 'CD 규격 이탈', 'CD SEM 전수측정'],
    ...
    ['100', 'Au Plating', 'Au 전해도금으로 접합부 금속층을 형성한다', 'Au Bump 높이', 'CC', '높이 편차', '높이 측정기 전수검사, 외관 샘플링 검사'],
  ...
  'L3 통합(B1-B5)': [
    ...
    ['40', 'MC', 'Sputter 장비', 'Sputter 장비가 Ti/Cu를 증착하여 UBM층을 형성한다', 'DC Power', 'CC', 'Power 변동', 'Sputter 작업자 정기 숙련도 평가 + 작업표준 교육'],
    ['40', 'MC', 'Sputter 장비', 'DC Power Supply가 안정 전력을 공급하여 증착 균일성을 확보한다', '전압 안정도', '', '전압 변동', 'Sputter 작업자 정기 숙련도 평가 + 작업표준 교육'],
    ['40', 'MC', 'DC Power Supply', 'Sputter 장비가 Ti/Cu를 증착하여 UBM층을 형성한다', 'DC Power', 'CC', 'Power 변동', 'Sputter 작업자 정기 숙련도 평가 + 작업표준 교육'],
    ...
    ['70', 'MC', 'Stepper/Scanner', 'Stepper가 패턴을 노광하여 Bump 위치를 정의한다', '노광 에너지', 'CC', '에너지 편차', 'Exposure 작업자 정기 숙련도 평가 + 작업표준 교육'],
    ...
    ['100', 'MC', 'Au Plating Tank', 'Au Plating Tank가 Au를 전해도금하여 Bump Core를 형성한다', '전류밀도', 'CC', '전류밀도 편차', 'Plating 작업자 정기 숙련도 평가 + 작업표준 교육'],
    ['100', 'MC', 'Au Plating Tank', '정류기가 안정 전류를 공급하여 도금 균일성을 확보한다', '전류 안정도', '', '전류 변동', 'Plating 작업자 정기 숙련도 평가 + 작업표준 교육'],
    ['100', 'MC', '정류기(Rectifier)', 'Au Plating Tank가 Au를 전해도금하여 Bump Core를 형성한다', '전류밀도', 'CC', '전류밀도 편차', 'Plating 작업자 정기 숙련도 평가 + 작업표준 교육'],
    ...
    ['140', 'MC', 'Anneal 장비', 'Anneal 장비가 열처리로 금속 결합을 강화한다', 'Anneal 온도', 'CC', '온도 과다/부족', 'Anneal 작업자 정기 숙련도 평가 + 작업표준 교육'],
  ...
  'FA 통합분석': [
    ...
    ['YP', '표면 이물이 제거된 청정 Wafer를 후공정에 제공한다', 'Wafer 표면 외관 결함 부재(Visual Defect Absence)', '10', 'IQA(수입검사)', '입고 자재의 품질을 확인하여 불량 자재 유입을 방지한다', 'Wafer TTV', 'CC', 'IM', 'Wafer', 'Wafer가 후속 공정의 기판 역할을 한다', 'Wafer 규격', '', 'Wafer 표면 결함 미검출로 인한 후공정 유출', 'TTV 규격 초과', '자재 품질 부적합', '5', '3', '3', 'L', 'Wafer 두께 측정기 전수검사', '', '수입검사 강화', '자재 유효기한 관리', '', ''],
    ...
    ['YP', 'Au Bump가 규격 높이와 균일도로 형성된 Wafer를 제공한다', 'Au Bump 형상 적합성(Bump Shape Integrity)', '40', 'UBM Sputter', 'Ti/Cu UBM 증착으로 Bump 접합층을 형성한다', 'UBM 두께', 'CC', 'MC', 'Sputter 장비', 'DC Power Supply가 안정 전력을 공급하여 증착 균일성을 확보한다', '전압 안정도', '', '전기적 Open/Short', 'UBM 두께 부족', 'Power 변동', '7', '3', '4', 'M', 'SEM 검사, 4-Point Probe', 'SPC 관리도', '', '', '', '3'],
    ['YP', 'Au Bump가 규격 높이와 균일도로 형성된 Wafer를 제공한다', 'Au Bump 형상 적합성(Bump Shape Integrity)', '40', 'UBM Sputter', 'Ti/Cu UBM 증착으로 Bump 접합층을 형성한다', 'UBM 두께', 'CC', 'MC', 'DC Power Supply', 'DC Power Supply가 안정적인 전압을 공급하여 Sputter Power를 유지한다', '전압 안정도', '', '전기적 Open/Short', 'UBM 두께 부족', '전압 변동', '7', '3', '4', 'M', 'SEM 검사, 4-Point Probe', 'SPC 관리도', '', '', '', '3'],
    ['YP', 'Au Bump가 규격 높이와 균일도로 형성된 Wafer를 제공한다', 'Au Bump 형상 적합성(Bump Shape Integrity)', '40', 'UBM Sputter', 'Ti/Cu UBM 증착으로 Bump 접합층을 형성한다', 'UBM 두께', 'CC', 'EN', '진공 챔버', '진공 챔버가 진공 환경을 유지하여 증착 품질을 확보한다', '진공도', '', 'Bump Lift-off', 'UBM 두께 부족', '진공 누설', '7', '3', '4', 'M', 'SEM 검사, 4-Point Probe', 'SPC 관리도', '', '', '', '3'],
    ...
    ['YP', 'Au Bump가 규격 높이와 균일도로 형성된 Wafer를 제공한다', 'Au Bump 형상 적합성(Bump Shape Integrity)', '70', 'Exposure', 'PR을 노광하여 Bump 패턴을 전사한다', 'CD(Critical Dimension)', 'CC', 'MC', 'Stepper/Scanner', 'Stepper가 패턴을 노광하여 Bump 위치를 정의한다', '노광 에너지', 'CC', 'Bump간 Bridge', 'CD 규격 이탈', '에너지 편차', '7', '3', '3', 'M', 'CD SEM 측정', 'SPC 관리도', '', '', '', ''],
    ['YP', 'Au Bump가 규격 높이와 균일도로 형성된 Wafer를 제공한다', 'Au Bump 형상 적합성(Bump Shape Integrity)', '70', 'Exposure', 'PR을 노광하여 Bump 패턴을 전사한다', 'CD(Critical Dimension)', 'CC', 'IM', 'Mask(Reticle)', 'Mask가 패턴 원본을 제공하여 노광 정밀도를 확보한다', 'Mask CD', '', 'Bump간 Bridge', 'CD 규격 이탈', 'Mask 결함', '7', '3', '3', 'L', 'CD SEM 측정', 'SPC 관리도', '', '', '', ''],
    ...
    ['YP', 'Au Bump가 규격 높이와 균일도로 형성된 Wafer를 제공한다', 'Au Bump 형상 적합성(Bump Shape Integrity)', '100', 'Au Plating', 'Au 전해도금으로 접합부 금속층을 형성한다', 'Au Bump 높이', 'CC', 'MC', 'Au Plating Tank', '정류기가 안정 전류를 공급하여 도금 균일성을 확보한다', '전류 안정도', '', '전기적 Open/Short', '높이 편차', '전류밀도 편차', '7', '3', '4', 'H', '높이 측정기, 외관검사', '', '', '', '', '3'],
    ['YP', 'Au Bump가 규격 높이와 균일도로 형성된 Wafer를 제공한다', 'Au Bump 형상 적합성(Bump Shape Integrity)', '100', 'Au Plating', 'Au 전해도금으로 접합부 금속층을 형성한다', 'Au Bump 높이', 'CC', 'MC', '정류기(Rectifier)', '정류기가 직류 전류를 공급하여 도금 전류밀도를 제어한다', '전류 안정도', '', '전기적 Open/Short', '높이 편차', '전류 변동', '7', '3', '4', 'M', '높이 측정기, 외관검사', '', '', '', '', '3'],
    ...
    ['SP', 'Au Bump 전단강도 및 높이가 고객 규격을 만족하는 Wafer를 제공한다', 'IMC 두께(IMC Thickness, μm)', '140', 'Anneal', '열처리로 Bump 금속 결합을 강화한다', 'IMC 두께', '', 'MC', 'Anneal 장비', 'Anneal 장비가 열처리로 금속 결합을 강화한다', 'Anneal 온도', 'CC', 'IMC 과성장에 의한 접합부 열화', 'IMC 과성장', '온도 과다/부족', '7', '4', '4', 'H', 'Cross-section SEM', '', '', '', '3', '3'],
    ...
    ['USER', 'RoHS·REACH 규제 유해물질 기준을 준수하는 Wafer를 제공한다', 'RoHS 유해물질 기준 적합성(RoHS Compliance)', '150', 'Final Inspection', '최종 외관·치수를 검사하여 출하 합부를 판정한다', 'Bump 높이', 'CC', 'MC', '높이 측정기', '높이 측정기가 Bump 높이를 전수 측정하여 합부 데이터를 제공한다', '측정 정밀도', '', '고객 라인 정지, 클레임', '높이 규격 이탈', '측정 오차', '8', '3', '3', 'M', '높이 측정기 전수검사', '', '', '', '', ''],
    ...
    ['SP', '외관 결함이 없고 고객 Packing 기준에 맞게 포장된 Wafer를 제공한다', 'Au Bump 전단강도(Shear Strength, gf) — CC', '190', 'AVI', '자동외관검사로 최종 품질을 확인한다', 'Defect 수', '', 'MC', 'AVI 장비', 'AVI가 자동외관검사로 최종 결함을 검출한다', '검사 해상도', '', '외관 결함 불량 유출(고객 Outgoing Defect)', '외관 결함 미검출', '해상도 저하', '6', '3', '3', 'L', 'AVI 이중 검사', 'AVI 2차 검사', '', '', '', ''],
    ['SP', 'Au Bump 전단강도 및 높이가 고객 규격을 만족하는 Wafer를 제공한다', 'Au Bump 높이 균일도(Bump Co-planarity, μm) — CC', '200', 'OGI/Packing', '출하 검사 및 포장으로 제품을 보호한다', '포장 상태', '', 'MC', '포장 장비', '포장 장비가 제품을 보호 포장하여 운송 손상을 방지한다', '포장 진공도', '', '고객 Packing 기준 부적합으로 인한 납품 Reject', '포장 불량', '진공 누설', '8', '3', '3', 'L', '포장 체크리스트 확인', '', '', '', '', ''],
  ],
};
