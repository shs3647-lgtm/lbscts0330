 ...
 * - L2.functions[].productChars → productChar (제품특성)
 * - L3.processChars → processChar (공정특성)
...
// 4M 분류 아이콘 및 색상 (HARDCODED)
const M4_CONFIG: Record<string, { icon: string; label: string; color: string }> = {
    MC: { icon: '🏭', label: '설비 (Machine)', color: '#3b82f6' },
    MD: { icon: '🔧', label: '금형 (Mold/Die)', color: '#8b5cf6' },
    JG: { icon: '📐', label: '지그 (Jig)', color: '#10b981' },
    IM: { icon: '📦', label: '투입자재 (InMaterial)', color: '#f59e0b' },
    MN: { icon: '👤', label: '사람 (Man)', color: '#ef4444' }, // CP 제외
    EN: { icon: '🌍', label: '작업환경 (Environment)', color: '#06b6d4' },
...
const STEP_COLS: Record<number, {
    ...
    1: {
        ...
        cols: [
            ...
            { key: 'productChar', label: '제품특성', cpLabel: '', w: '20%', bg: 'bg-blue-50' },
            { key: 'processChar', label: '공정특성', cpLabel: '', w: '20%', bg: 'bg-purple-50' },
    ...
    3: {
        ...
        cols: [
            { key: 'processNo', label: 'No', cpLabel: '', w: '5%', merge: 'proc' },
            { key: 'processName', label: '공정', cpLabel: '', w: '10%', merge: 'proc' },
            { key: 'productChar', label: '제품특성', cpLabel: '', w: '70%', bg: 'bg-blue-50' },
    ...
    4: {
        ...
        cols: [
            ...
            { key: 'processChar', label: '공정특성', cpLabel: '', w: '50%', bg: 'bg-purple-50' },
            { key: 'specialChar', label: 'SC', cpLabel: '', w: '5%', renderAs: 'sc' },
        ],
    },
    5: {
        ...
        cols: [
            { key: 'processNo', label: 'No', cpLabel: '', w: '5%', merge: 'proc' },
            { key: 'processName', label: '공정', cpLabel: '', w: '10%', merge: 'proc' },
            { key: 'productChar', label: '제품특성', cpLabel: '', w: '35%', bg: 'bg-blue-50' },
            { key: 'processChar', label: '공정특성', cpLabel: '', w: '35%', bg: 'bg-purple-50' },
            { key: 'specialChar', label: 'SC', cpLabel: '', w: '5%', renderAs: 'sc' },
        ],
    },
};
            ...
            (l2.functions || []).forEach((func: any) => {
                ...
                (func.productChars || []).forEach((pc: any) => {
                    ...
                    (l2.l3 || []).forEach((l3: any) => {
                        ...
                        // ★ L3.functions[].processChars에서 공정특성 수집 (신규 구조)
