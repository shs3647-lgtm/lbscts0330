...
const VERIFY_ITEMS: { value: 'FE' | 'FM' | 'FC'; label: string; color: string }[] = [
  { value: 'FE', label: '1L 고장영향', color: '#1976d2' },
  { value: 'FM', label: '2L 고장형태', color: '#388e3c' },
  { value: 'FC', label: '3L 고장원인', color: '#f57c00' },
];
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    try {
                      ...
                      if (nid) localStorage.setItem(`pfmea_tab_${nid}`, 'all');
                    } catch { /* ignore */ }
                  }}
