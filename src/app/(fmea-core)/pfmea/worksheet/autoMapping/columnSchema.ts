...
const functionL2Schema: TabSchema = {
  columns: [
    { field: 'l2[].functions[].name',                      itemCode: 'A3', matchKey: 'processNo', label: '공정기능' },
    { field: 'l2[].functions[].productChars[].name',       itemCode: 'A4', matchKey: 'processNo', label: '제품특성' },
  ],
...
const functionL3Schema: TabSchema = {
  columns: [
    ...
    { field: 'l2[].l3[].functions[].processChars[].name',  itemCode: 'B3', matchKey: 'processNo::m4', label: '공정특성' },
  ],
