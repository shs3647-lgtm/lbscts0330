    ...
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/40" onClick={onClose}>
      <div className="bg-white rounded-lg shadow-2xl w-[480px] max-h-[80vh] flex flex-col" onClick={e => e.stopPropagation()}>
        <div className="bg-red-600 text-white px-4 py-2.5 rounded-t-lg flex items-center justify-between">
          <span className="font-bold text-sm">IM 원자재 오류 상세 ({imErrors.length}건)</span>
          ...
          <table className="w-full text-[11px] border-collapse">
            <thead>
              <tr className="bg-red-50">
                ...
                <th className="border px-2 py-1 text-left">공정</th>
                <th className="border px-2 py-1 text-left">작업요소</th>
                <th className="border px-2 py-1 text-left">4M</th>
                <th className="border px-2 py-1 text-left">오류값</th>
                <th className="border px-2 py-1 text-left">출처</th>
              </tr>
            </thead>
            <tbody>
              {imErrors.map((err, i) => (
