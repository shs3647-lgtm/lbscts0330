...
// ============ 색상 헬퍼 ============
// ★★★ 2026-01-26: level-colors.ts의 ZEBRA_COLORS와 통일 ★★★
export const LEVEL_COLORS = {
  l1: { bg: '#e3f2fd', text: '#1565c0', border: '#1976d2' },   // 파란색 (완제품)
  l2: { bg: '#e8f5e9', text: '#2e7d32', border: '#388e3c' },   // 녹색 (메인공정)
  l3: { bg: '#fff3e0', text: '#e65100', border: '#f57c00' },   // 주황색 (작업요소)
};
