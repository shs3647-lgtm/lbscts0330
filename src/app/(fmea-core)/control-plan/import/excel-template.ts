...
const WS_SAMPLE_DATA: string[][] = [
  ...
  ['20', '수입검사', 'Main', '원부자재 샘플링 수입검사 실시', 'Mooney Viscometer', '성적서 확인', 'Mooney Viscometer', 'Mooney Viscosity', '검사 정밀도', 'CC', 'Mooney 50±5', 'Mooney Viscometer', 'n=5', '매Lot', '성적서관리', '검사원', '품질팀장', '재검사, 불합격 시 반품'],
  ...
  ['30', 'MB Mixing', 'Main', '마스터배치 조건에 따라 혼련', 'MB Mixer, 믹싱롤', '온도 알람', '온도 센서', 'Mooney Viscosity', '혼련 온도', 'CC', 'Mooney 60±5', 'Rheometer', 'n=3', '매Batch', 'SPC관리', '작업자', '공정팀장', '재작업, 공정 조건 확인'],
  ...
  ['50', '압출', 'Main', '고무를 압출하여 반제품 생산', '압출기', '두께 알람', '두께 측정기', 'Tread 폭', '압출 온도', 'CC', 'Tread 폭 100±2mm', '두께 측정', 'n=5', '매시', '관리도', '작업자', '', '라인 정지, 조건 재설정'],
  ...
  ['80', '성형', 'Main', '그린타이어 반제품 접착', '성형기', '바코드 Poka-Yoke', '바코드 스캐너', 'B2B 폭', 'Center Deck 센터링', 'CC', 'B2B 폭 규격', '육안검사', 'n=1', '매개', '체크시트', '작업자', '', '재작업, 지그 점검'],
  ['90', '가류', 'Main', '그린타이어를 가열/가압하여 완제품 생산', '가류기', '온도/시간 알람', '온도 기록계', '가류도', '가류 온도', 'CC', '가류도 규격', '가류도 측정', 'n=3', '매Lot', 'SPC관리', '작업자', '품질팀장', '재가류, 폐기'],
