...
const CP_SAMPLE_DATA: Record<string, string[][]> = {
  '공정현황': [
    ['10', '자재입고', 'Main', 'Wafer 및 원부자재 입고 검수', '바코드 스캐너, 입고대'],
    ['20', '수입검사', 'Main', 'Wafer 외관 및 물성 수입검사 실시', '현미경, 프로브 스테이션'],
    ['30', 'Scrubber', 'Main', 'Wafer 표면 세정 처리', 'Scrubber 장비'],
    ['40', 'UBM Sputter', 'Main', 'Under Bump Metallurgy 증착', 'Sputter 장비'],
    ['50', 'PR Coating', 'Main', 'Photo Resist 도포', 'Coater'],
    ['60', 'Expose/Develop', 'Main', '노광 및 현상 공정', 'Stepper, Developer'],
    ['70', 'Au Plating', 'Main', 'Au Bump 전기도금', '도금조'],
    ['80', 'PR Strip', 'Sub', 'Photo Resist 제거', 'Strip 장비'],
    ['90', 'UBM Etch', 'Sub', 'UBM 에칭 공정', 'Wet Etch 장비'],
    ['100', 'Reflow', 'Main', 'Bump Reflow 처리', 'Reflow Oven'],
    ['110', '완성검사', 'Main', 'Bump 높이/위치/외관 최종검사', '3D 측정기, 현미경'],
    ['120', '출하', 'Sub', '완성품 포장 및 출하', '포장장비, 출하대'],
  ],
  '관리항목': [
    ['10', '자재입고', 'Wafer 외관', '입고 온습도', '', '온도 23±2℃, 습도 45±10%'],
    ['20', '수입검사', 'Wafer 두께', '검사 정밀도', '★', 'TTV ≤ 2μm'],
    ['30', 'Scrubber', '파티클 수', '세정 시간', '', '파티클 ≤ 50ea/wafer'],
    ['40', 'UBM Sputter', 'Ti/Cu 막두께', 'Sputter Power', '★', 'Ti 1000±100Å, Cu 5000±500Å'],
    ['50', 'PR Coating', 'PR 두께', 'Spin Speed', 'SC', 'PR 두께 25±2μm'],
    ['60', 'Expose/Develop', 'CD(Critical Dimension)', '노광량', '★', 'CD 50±3μm'],
    ['70', 'Au Plating', 'Bump 높이', '도금 전류밀도', '★', 'Bump 높이 15±2μm'],
    ['80', 'PR Strip', 'PR 잔여물', 'Strip 시간', '', 'PR 잔여물 없음'],
    ['90', 'UBM Etch', 'UBM 잔여물', 'Etch Rate', '', 'Under-cut ≤ 3μm'],
    ['100', 'Reflow', 'Bump 형상', 'Reflow 온도', '★', 'Bump 구형도 ≥ 0.9'],
    ['110', '완성검사', 'Bump 높이 균일도', '검사 정밀도', '', 'σ ≤ 1.5μm'],
  ],
  '관리방법': [
    ['10', '자재입고', '육안검사', 'n=3', '매입고', '검수기록', '검사원', ''],
    ['20', '수입검사', '프로브 측정', 'n=5', '매Lot', '성적서관리', '검사원', '품질팀장'],
    ['30', 'Scrubber', '파티클 카운터', 'n=3', '매Batch', 'SPC관리', '작업자', '공정팀장'],
    ['40', 'UBM Sputter', '4-Point Probe', 'n=5', '매Lot', 'SPC관리', '작업자', '품질팀장'],
    ['50', 'PR Coating', '막두께 측정기', 'n=3', '매Lot', '관리도', '작업자', ''],
    ['60', 'Expose/Develop', 'CD SEM', 'n=5', '매Lot', 'SPC관리', '작업자', '품질팀장'],
    ['70', 'Au Plating', '3D 측정기', 'n=10', '매Lot', 'SPC관리', '작업자', '품질팀장'],
    ['80', 'PR Strip', '현미경', 'n=3', '매Batch', '체크시트', '작업자', ''],
    ['100', 'Reflow', '3D 측정기', 'n=5', '매Lot', 'SPC관리', '작업자', '품질팀장'],
    ['110', '완성검사', '자동 광학검사', '전수', '매Wafer', '자동검사', '검사원', '품질팀장'],
  ],
  '대응계획': [
    ['10', '자재입고', 'Wafer 외관', '입고 온습도', '반품 처리, 입고 중지'],
    ['20', '수입검사', 'Wafer 두께', '검사 정밀도', '재검사, 불합격 시 반품'],
    ['30', 'Scrubber', '파티클 수', '세정 시간', '재세정, 장비 PM'],
    ['40', 'UBM Sputter', 'Ti/Cu 막두께', 'Sputter Power', '타겟 교체, 조건 재설정'],
    ['50', 'PR Coating', 'PR 두께', 'Spin Speed', '재도포, 장비 점검'],
    ['60', 'Expose/Develop', 'CD', '노광량', '재작업, Mask 점검'],
    ['70', 'Au Plating', 'Bump 높이', '도금 전류밀도', '도금액 분석, 조건 재설정'],
    ['80', 'PR Strip', 'PR 잔여물', 'Strip 시간', '재Strip, 약액 교체'],
    ['100', 'Reflow', 'Bump 형상', 'Reflow 온도', '프로파일 재설정, 장비 점검'],
    ['110', '완성검사', 'Bump 높이 균일도', '검사 정밀도', '불량 폐기, 원인 분석'],
  ],
  '검출장치': [
    ['10', '자재입고', '입고 확인 Poka-Yoke', '바코드 스캐너'],
    ['20', '수입검사', '자동 두께 측정', '프로브 스테이션'],
    ['30', 'Scrubber', '파티클 알람', '파티클 카운터'],
    ['40', 'UBM Sputter', '막두께 모니터링', '4-Point Probe'],
    ['50', 'PR Coating', '두께 알람', '막두께 측정기'],
    ['60', 'Expose/Develop', 'CD 모니터링', 'CD SEM'],
    ['70', 'Au Plating', '높이 모니터링', '3D 측정기'],
    ['100', 'Reflow', '온도 프로파일 알람', '온도 기록계'],
    ['110', '완성검사', '자동 불량 분류', 'AOI 검사기'],
  ],
};
