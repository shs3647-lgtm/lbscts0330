  ...
  return (
    ...
    >
      ...
      <div className="hidden sm:flex items-center gap-1 shrink-0">
        ...
        <button
          onClick={() => router.push(linkedPfdNo ? `/pfd/worksheet?pfdNo=${encodeURIComponent(linkedPfdNo.toLowerCase())}` : '/pfd/worksheet')}
        ...
        <button
          onClick={() => router.push(fmeaId ? `/pfmea/worksheet?id=${encodeURIComponent(fmeaId.toLowerCase())}` : '/pfmea/worksheet')}
