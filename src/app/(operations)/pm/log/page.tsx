/**
 * @file page.tsx
 * @description PM 접속 로그 페이지 - API 연동
 * @version 3.0.0
...
// 메인 컴포넌트
// =====================================================
export default function PMAccessLogPage() {
  ...
  const loadLogs = useCallback(async () => {
    setLoading(true);
    try {
      const res = await fetch('/api/auth/access-log?module=PM&limit=100');
      if (res.ok) {
          ...
          <div className="max-w-[1400px] mx-auto">
            ...
            <div className="flex items-center justify-between mb-4 mt-2">
              <div className="flex items-center gap-3">
                <h1 className="text-xl font-bold text-violet-700">PM 접속 로그</h1>
                <button
                  onClick={loadLogs}
                  disabled={loading}
