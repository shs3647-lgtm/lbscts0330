        ...
        <div className="fixed z-[9999] bg-white rounded-lg shadow-2xl flex flex-col select-none border border-gray-300"
            ...
            <div className="px-4 py-2 bg-yellow-50 border-b">
                <div className="flex items-center gap-2 text-xs">
                    <span className="text-yellow-600 font-bold">⚠️ 안내:</span>
                    <span>연동 CP는 자동 생성됩니다. 기존 CP에 연동하면 데이터가 손상될 수 있습니다.</span>
                </div>
                <div className="mt-1 text-xs text-teal-700 font-semibold">
                    현재 PFD ({pfdId})의 연동 CP: <span className="px-1 py-0.5 bg-teal-500 text-white rounded">{generateLinkedCpNo(pfdId) || '(PFD ID 필요)'}</span>
                </div>
            </div>
