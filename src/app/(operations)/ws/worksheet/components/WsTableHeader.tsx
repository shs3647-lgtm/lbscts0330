/**
 * @file WsTableHeader.tsx
 * @description WS 워크시트 테이블 헤더 (3행 구조)
 */

import React, { memo } from 'react';
import { HEIGHTS, PFD_COLUMNS, calculateGroupSpans } from '../pfdConstants';
 ...
 * - 3행: 열번호 (NO, A, B, C...)
 */
function WsTableHeaderComponent({
    columnWidths,
    getColumnWidth,
    startResize,
    resetColumnWidth,
    ...
    const groupSpans = calculateGroupSpans(PFD_COLUMNS);
...
export const WsTableHeader = memo(WsTableHeaderComponent);
