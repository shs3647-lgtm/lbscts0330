...
import { WSMainDocument, PartItem } from '@/types/ws-main';

interface WsPartsTabProps {
    document: WSMainDocument;
    setDocument: React.Dispatch<React.SetStateAction<WSMainDocument>>;
}

function WsPartsTabInner({ document, setDocument }: WsPartsTabProps) {
...
const WsPartsTab = React.memo(WsPartsTabInner);
export default WsPartsTab;
