    ...
    return (
        <tbody>
            ...
            {items.map((item, rowIdx) => (
                <tr key={item.id}>
                    {PFD_COLUMNS.map(col => renderCell({
                        item,
                        col,
                        rowIdx,
                        items,
...
export const WsTableBody = memo(WsTableBodyComponent);
