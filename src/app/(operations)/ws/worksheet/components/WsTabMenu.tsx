...
function WsTabMenuInner({
    ...
    // ★★★ WS 탭 구조: 첫화면 = WS Work Sheet ★★★
    const tabs = [
        { id: 'ws-main', label: 'WS Main', icon: '📋', count: undefined },
        { id: 'ws-worksheet', label: 'WS Work Sheet', icon: '📝', count: itemCount },
        { id: 'equipment', label: '설비/TOOL', icon: '🔧', count: undefined },
        { id: 'parts', label: '부품 리스트', icon: '📦', count: undefined },
    ];
...
export const WsTabMenu = React.memo(WsTabMenuInner);
