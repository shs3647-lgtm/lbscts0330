...
const GROUP_FILTER_OPTIONS = [
  { value: '', label: '전체보기' },
  { value: 'processInfo', label: '공정정보' },
  { value: 'characteristic', label: '특성정보' },
];

// 개별 컬럼 필터 옵션
const COLUMN_FILTER_OPTIONS = [
  { value: '', label: '전체보기' },
  { value: 'processNo', label: '공정번호' },
  { value: 'processName', label: '공정명' },
  { value: 'processDesc', label: '공정설명' },
  { value: 'workElement', label: '작업요소' },
  { value: 'equipment', label: '설비/금형/지그' },
  { value: 'productSpecialChar', label: '제품특별특성' },
  { value: 'productChar', label: '제품특성' },
  { value: 'processSpecialChar', label: '공정특별특성' },
  { value: 'processChar', label: '공정특성' },
];
