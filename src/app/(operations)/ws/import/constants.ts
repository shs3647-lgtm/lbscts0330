...
export const PREVIEW_COLUMNS: PreviewColumn[] = [
  // 공정정보 (5컬럼) - 합계: 55%
  { key: 'processNo', label: '공정번호', width: 'w-[6%]', group: 'processInfo' },
  { key: 'processName', label: '공정명', width: 'w-[10%]', group: 'processInfo' },
  { key: 'processDesc', label: '공정설명', width: 'w-[20%]', group: 'processInfo' },
  { key: 'workElement', label: '작업요소', width: 'w-[10%]', group: 'processInfo' },
  { key: 'equipment', label: '설비/금형/지그', width: 'w-[9%]', group: 'processInfo' },
  // 특성정보 (4컬럼) - 합계: 38%
  { key: 'productSpecialChar', label: '제품특별특성', width: 'w-[8%]', group: 'characteristic' },
  { key: 'productChar', label: '제품특성', width: 'w-[10%]', group: 'characteristic' },
  { key: 'processSpecialChar', label: '공정특별특성', width: 'w-[8%]', group: 'characteristic' },
  { key: 'processChar', label: '공정특성', width: 'w-[12%]', group: 'characteristic' },
];
...
export const GROUP_HEADERS = [
  { key: 'processInfo', label: '공정정보', colSpan: 5, color: 'bg-teal-600' },
  { key: 'characteristic', label: '특성정보', colSpan: 4, color: 'bg-blue-600' },
];
