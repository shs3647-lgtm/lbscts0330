...
export default function UsersSettingsPage() {
  ...
  const { pos: modalPos, size: modalSize, onDragStart: modalDragStart, onResizeStart: modalResizeStart } = useFloatingWindow({ isOpen: isModalOpen, width: 680, height: 560 });
      ...
      <div className="p-4 h-full overflow-auto">
              ...
              <tbody>
                {filteredUsers.map((user, idx) => {
                  ...
                  return (
                    <tr
                      key={user.id}
                      className={`border-b hover:bg-blue-50 transition-colors ${idx % 2 === 1 ? 'bg-gray-50/50' : ''
        ...
        {isModalOpen && (
          <div className="fixed z-[9999] bg-white rounded-lg shadow-2xl flex flex-col select-none border border-gray-300"
            ...
            <div className="bg-gradient-to-r from-indigo-600 to-indigo-700 text-white p-4 rounded-t-lg flex items-center justify-between cursor-move" onMouseDown={modalDragStart}>
            ...
            <div className="absolute bottom-0 right-0 w-4 h-4 cursor-se-resize" onMouseDown={modalResizeStart} title="크기 조절">
