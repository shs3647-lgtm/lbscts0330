      ...
      <div className="bg-white rounded-lg shadow-lg overflow-hidden">
        <div className="overflow-x-auto">
          <table className="w-full text-xs border-collapse">
            ...
            <thead>
              <tr>
                <th className="bg-[#00587a] text-white font-bold px-2 py-2 text-center border border-[#999] whitespace-nowrap">AP(전)</th>
                <th className="bg-[#00587a] text-white font-bold px-2 py-2 text-center border border-[#999] whitespace-nowrap">AP(후)</th>
                <th className="bg-[#00587a] text-white font-bold px-2 py-2 text-center border border-[#999] whitespace-nowrap">RPN(전)</th>
                <th className="bg-[#00587a] text-white font-bold px-2 py-2 text-center border border-[#999] whitespace-nowrap">RPN(후)</th>
