 ...
 * └───────┴──────┴────┴────────┴──────┴──┴────┴──┴──────┴──────┴────┴──────┴────┴────┴────┴──┴──┴────┘
 *
 * DFMEA 연동 필드 (CP_PFMEA_데이터연계성.md 기준):
 * - 공정번호/공정명 ↔ DFMEA L2.no/name (processNo, processName)
 * - 공정설명 ↔ DFMEA L3 작업요소 [4M + 작업요소명] (processDesc)
 * - 작업요소 기능 ↔ DFMEA L3.functions (workElement)
 * - 제품특성 ↔ DFMEA L2.functions.productChars (productChar)
 * - 공정특성 ↔ DFMEA L3.functions.processChars (processChar)
 * - 특별특성 ↔ DFMEA specialChar (specialChar)
 * - 관리방법 ↔ DFMEA 예방관리/검출관리 (controlMethod)
 */
...
export interface CPRow {
  ...
  // ===== 공정현황 (DFMEA 연동) =====
  processNo: string;        // 공정번호 ↔ DFMEA L2.no
  processName: string;      // 공정명 ↔ DFMEA L2.name
  processType: string;      // 형태 (메인/서브)
  processDesc: string;      // 공정설명 ↔ DFMEA L3 [4M + 작업요소명]
  workElement: string;      // 작업요소 기능 ↔ DFMEA L3.functions
