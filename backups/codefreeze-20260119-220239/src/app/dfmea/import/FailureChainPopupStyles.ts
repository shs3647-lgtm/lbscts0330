/**
 * @file FailureChainPopupStyles.ts
 * @description FailureChainPopup 동적 스타일 함수
 */
...
/** 다이어그램 컨테이너 스타일 */
export const diagramContainerStyle: CSSProperties = {
  display: 'flex',
  alignItems: 'center',
  justifyContent: 'center',
  gap: '16px',
...
/** 박스 스타일 */
export const boxStyle = (bg: string, border: string): CSSProperties => ({
  padding: '16px 24px',
  background: bg,
