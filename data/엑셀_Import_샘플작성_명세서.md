...
> **목적**: m066 DB와 100% 동일한 FMEA를 재현할 수 있는 Import 엑셀 샘플 생성
> **기준**: pfm26-m066 (12inch Au Bump) — 2026-03-21 확정
> **생성 스크립트**: `scripts/gen-import-sample.mjs`
> **출력 파일**: `data/m066_완벽_Import_Sample.xlsx`
...
```bash
# 사전 조건: m066 마스터 JSON 최신화
node -e "const d=JSON.parse(require('fs').readFileSync('data/master-fmea/pfm26-m066.json','utf8')); console.log('chains:', d.chains.length, 'FL:', d.atomicDB.failureLinks.length);"
# → chains: 111 FL: 111 확인

# 샘플 엑셀 생성
node scripts/gen-import-sample.mjs
# → data/m066_완벽_Import_Sample.xlsx 생성
...
```
1. m066_완벽_Import_Sample.xlsx → Import
