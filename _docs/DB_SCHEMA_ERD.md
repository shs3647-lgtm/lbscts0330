...
flowchart LR
    ...
    subgraph Failure["고장분석 (4단계)"]
        ...
        FM[FailureMode<br/>고장형태 FM<br/>★ 중심축]
...
- [DB_SCHEMA.md](./DB_SCHEMA.md) - 테이블 상세 정의
- [schema.ts](../src/app/pfmea/worksheet/schema.ts) - TypeScript 스키마
- [shared-schema.ts](../src/lib/shared-schema.ts) - 공유 스키마
...
| 버전 | 날짜 | 변경 내용 |
|------|------|----------|
| 2.0.0 | 2026-01-03 | Mermaid 다이어그램 문서 생성 |
