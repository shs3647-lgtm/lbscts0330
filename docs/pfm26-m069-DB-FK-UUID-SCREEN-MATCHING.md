...
## 1. 총괄 카운트 (m066 레퍼런스 비교)

| 항목 | m069 실측 | m066 레퍼런스 | 차이 | 비고 |
|------|--------:|--------:|------:|------|
...
| 코드 | 항목명 | Atomic DB | Legacy | Master JSON | m066 레퍼 | PASS |
|------|--------|--------:|-------:|--------:|--------:|:----:|
| **A1** | 공정번호 | 21 | 21 | 21 | 21 | ✅ |
| **A2** | 공정명 | 21 | 21 | 21 | 21 | ✅ |
| **A3** | 공정기능 | 21 | 21 | 21 | 21 | ✅ |
...
> m066 대비 L3F/FC/Link가 각 +14건 증가. 이는 Atomic DB 자동보충(orphan L3에 FC 생성)에 의한 정상 증가.
